...
pub struct PHASE2_W<'a> { w: &'a mut W }
...
pub struct PHASE1_W<'a> { w: &'a mut W }
...
pub struct PROPAG_W<'a> { w: &'a mut W }
...
pub enum SMP_A { #[doc = "0: The incoming bit stream is sampled once at sample point."] ONCE = 0, #[doc = "1: The incoming bit stream is sampled three times with a period of a MCK clock period, centered on sample point."] THREE = 1 }

impl From<SMP_A> for bool {
    #[inline(always)]
    fn from(variant: SMP_A) -> Self { variant as u8 != 0 }
}
...
impl SMP_R {
    ...
    #[inline(always)]
    pub fn is_once(&self) -> bool { *self == SMP_A::ONCE }
    #[doc = "Checks if the value of the field is `THREE`"]
    #[inline(always)]
    pub fn is_three(&self) -> bool { *self == SMP_A::THREE }
}

#[doc = "Write proxy for field `SMP`"]
pub struct SMP_W<'a> { w: &'a mut W }

impl<'a> SMP_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: SMP_A) -> &'a mut W { { self.bit(variant.into()) } }
    #[doc = "The incoming bit stream is sampled once at sample point."]
    #[inline(always)]
    pub fn once(self) -> &'a mut W { self.variant(SMP_A::ONCE) }
    #[doc = "The incoming bit stream is sampled three times with a period of a MCK clock period, centered on sample point."]
    #[inline(always)]
    pub fn three(self) -> &'a mut W { self.variant(SMP_A::THREE) }
...
impl R {
    ...
    #[inline(always)]
    pub fn phase2(&self) -> PHASE2_R { PHASE2_R::new((self.bits & 0x07) as u8) }
    #[doc = "Bits 4:6 - Phase 1 segment"]
    #[inline(always)]
    pub fn phase1(&self) -> PHASE1_R { PHASE1_R::new(((self.bits >> 4) & 0x07) as u8) }
    #[doc = "Bits 8:10 - Programming time segment"]
    #[inline(always)]
    pub fn propag(&self) -> PROPAG_R { PROPAG_R::new(((self.bits >> 8) & 0x07) as u8) }
    #[doc = "Bits 12:13 - Re-synchronization jump width"]
    #[inline(always)]
    pub fn sjw(&self) -> SJW_R { SJW_R::new(((self.bits >> 12) & 0x03) as u8) }
    #[doc = "Bits 16:22 - Baudrate Prescaler."]
    #[inline(always)]
    pub fn brp(&self) -> BRP_R { BRP_R::new(((self.bits >> 16) & 0x7f) as u8) }
    #[doc = "Bit 24 - Sampling Mode"]
    #[inline(always)]
    pub fn smp(&self) -> SMP_R { SMP_R::new(((self.bits >> 24) & 0x01) != 0) }
}

impl W {
    #[doc = "Bits 0:2 - Phase 2 segment"]
    #[inline(always)]
    pub fn phase2(&mut self) -> PHASE2_W { PHASE2_W { w: self } }
    #[doc = "Bits 4:6 - Phase 1 segment"]
    #[inline(always)]
    pub fn phase1(&mut self) -> PHASE1_W { PHASE1_W { w: self } }
    #[doc = "Bits 8:10 - Programming time segment"]
    #[inline(always)]
    pub fn propag(&mut self) -> PROPAG_W { PROPAG_W { w: self } }
    #[doc = "Bits 12:13 - Re-synchronization jump width"]
    #[inline(always)]
    pub fn sjw(&mut self) -> SJW_W { SJW_W { w: self } }
    #[doc = "Bits 16:22 - Baudrate Prescaler."]
    #[inline(always)]
    pub fn brp(&mut self) -> BRP_W { BRP_W { w: self } }
    #[doc = "Bit 24 - Sampling Mode"]
    #[inline(always)]
    pub fn smp(&mut self) -> SMP_W { SMP_W { w: self } }
}