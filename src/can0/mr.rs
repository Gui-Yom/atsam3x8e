...
pub struct CANEN_W<'a> { w: &'a mut W }
...
pub struct TIMFRZ_W<'a> { w: &'a mut W }
...
#[repr(u8)]
pub enum RXSYNC_A { #[doc = "0: Rx Signal with Double Synchro Stages (2 Positive Edges)"] DOUBLE_PP = 0, #[doc = "1: Rx Signal with Double Synchro Stages (One Positive Edge and One Negative Edge)"] DOUBLE_PN = 1, #[doc = "2: Rx Signal with Single Synchro Stage (Positive Edge)"] SINGLE_P = 2, #[doc = "3: Rx Signal with No Synchro Stage"] NONE = 3 }

impl From<RXSYNC_A> for u8 {
    #[inline(always)]
    fn from(variant: RXSYNC_A) -> Self { variant as _ }
}
...
impl RXSYNC_R {
    ...
    #[inline(always)]
    pub fn is_double_pp(&self) -> bool { *self == RXSYNC_A::DOUBLE_PP }
    #[doc = "Checks if the value of the field is `DOUBLE_PN`"]
    #[inline(always)]
    pub fn is_double_pn(&self) -> bool { *self == RXSYNC_A::DOUBLE_PN }
    #[doc = "Checks if the value of the field is `SINGLE_P`"]
    #[inline(always)]
    pub fn is_single_p(&self) -> bool { *self == RXSYNC_A::SINGLE_P }
    #[doc = "Checks if the value of the field is `NONE`"]
    #[inline(always)]
    pub fn is_none(&self) -> bool { *self == RXSYNC_A::NONE }
}

#[doc = "Write proxy for field `RXSYNC`"]
pub struct RXSYNC_W<'a> { w: &'a mut W }

impl<'a> RXSYNC_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: RXSYNC_A) -> &'a mut W { unsafe { self.bits(variant.into()) } }
    #[doc = "Rx Signal with Double Synchro Stages (2 Positive Edges)"]
    #[inline(always)]
    pub fn double_pp(self) -> &'a mut W { self.variant(RXSYNC_A::DOUBLE_PP) }
    #[doc = "Rx Signal with Double Synchro Stages (One Positive Edge and One Negative Edge)"]
    #[inline(always)]
    pub fn double_pn(self) -> &'a mut W { self.variant(RXSYNC_A::DOUBLE_PN) }
    #[doc = "Rx Signal with Single Synchro Stage (Positive Edge)"]
    #[inline(always)]
    pub fn single_p(self) -> &'a mut W { self.variant(RXSYNC_A::SINGLE_P) }
    #[doc = "Rx Signal with No Synchro Stage"]
    #[inline(always)]
    pub fn none(self) -> &'a mut W { self.variant(RXSYNC_A::NONE) }
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
...
impl R {
    ...
    #[inline(always)]
    pub fn canen(&self) -> CANEN_R { CANEN_R::new((self.bits & 0x01) != 0) }
    #[doc = "Bit 1 - Disable/Enable Low Power Mode"]
    #[inline(always)]
    pub fn lpm(&self) -> LPM_R { LPM_R::new(((self.bits >> 1) & 0x01) != 0) }
    #[doc = "Bit 2 - Disable/Enable Autobaud/Listen mode"]
    #[inline(always)]
    pub fn abm(&self) -> ABM_R { ABM_R::new(((self.bits >> 2) & 0x01) != 0) }
    #[doc = "Bit 3 - Disable/Enable Overload Frame"]
    #[inline(always)]
    pub fn ovl(&self) -> OVL_R { OVL_R::new(((self.bits >> 3) & 0x01) != 0) }
    #[doc = "Bit 4 - Timestamp messages at each end of Frame"]
    #[inline(always)]
    pub fn teof(&self) -> TEOF_R { TEOF_R::new(((self.bits >> 4) & 0x01) != 0) }
    #[doc = "Bit 5 - Disable/Enable Time Triggered Mode"]
    #[inline(always)]
    pub fn ttm(&self) -> TTM_R { TTM_R::new(((self.bits >> 5) & 0x01) != 0) }
    #[doc = "Bit 6 - Enable Timer Freeze"]
    #[inline(always)]
    pub fn timfrz(&self) -> TIMFRZ_R { TIMFRZ_R::new(((self.bits >> 6) & 0x01) != 0) }
    #[doc = "Bit 7 - Disable Repeat"]
    #[inline(always)]
    pub fn drpt(&self) -> DRPT_R { DRPT_R::new(((self.bits >> 7) & 0x01) != 0) }
    #[doc = "Bits 24:26 - Reception Synchronization Stage (not readable)"]
    #[inline(always)]
    pub fn rxsync(&self) -> RXSYNC_R { RXSYNC_R::new(((self.bits >> 24) & 0x07) as u8) }
}

impl W {
    #[doc = "Bit 0 - CAN Controller Enable"]
    #[inline(always)]
    pub fn canen(&mut self) -> CANEN_W { CANEN_W { w: self } }
    #[doc = "Bit 1 - Disable/Enable Low Power Mode"]
    #[inline(always)]
    pub fn lpm(&mut self) -> LPM_W { LPM_W { w: self } }
    #[doc = "Bit 2 - Disable/Enable Autobaud/Listen mode"]
    #[inline(always)]
    pub fn abm(&mut self) -> ABM_W { ABM_W { w: self } }
    #[doc = "Bit 3 - Disable/Enable Overload Frame"]
    #[inline(always)]
    pub fn ovl(&mut self) -> OVL_W { OVL_W { w: self } }
    #[doc = "Bit 4 - Timestamp messages at each end of Frame"]
    #[inline(always)]
    pub fn teof(&mut self) -> TEOF_W { TEOF_W { w: self } }
    #[doc = "Bit 5 - Disable/Enable Time Triggered Mode"]
    #[inline(always)]
    pub fn ttm(&mut self) -> TTM_W { TTM_W { w: self } }
    #[doc = "Bit 6 - Enable Timer Freeze"]
    #[inline(always)]
    pub fn timfrz(&mut self) -> TIMFRZ_W { TIMFRZ_W { w: self } }
    #[doc = "Bit 7 - Disable Repeat"]
    #[inline(always)]
    pub fn drpt(&mut self) -> DRPT_W { DRPT_W { w: self } }
    #[doc = "Bits 24:26 - Reception Synchronization Stage (not readable)"]
    #[inline(always)]
    pub fn rxsync(&mut self) -> RXSYNC_W { RXSYNC_W { w: self } }
}