...
impl W {
    ...
    #[inline(always)]
    pub fn mdlc(&mut self) -> MDLC_W { MDLC_W { w: self } }
    #[doc = "Bit 20 - Mailbox Remote Transmission Request"]
    #[inline(always)]
    pub fn mrtr(&mut self) -> MRTR_W { MRTR_W { w: self } }
    #[doc = "Bit 22 - Abort Request for Mailbox x"]
    #[inline(always)]
    pub fn macr(&mut self) -> MACR_W { MACR_W { w: self } }
    #[doc = "Bit 23 - Mailbox Transfer Command"]
    #[inline(always)]
    pub fn mtcr(&mut self) -> MTCR_W { MTCR_W { w: self } }
}