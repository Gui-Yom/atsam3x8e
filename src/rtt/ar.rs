...
impl crate::ResetValue for super::AR {
    #[inline(always)]
    fn reset_value() -> Self::Ux { 0xffff_ffff }
}
...
impl R {
    ...
    #[inline(always)]
    pub fn almv(&self) -> ALMV_R { ALMV_R::new((self.bits & 0xffff_ffff) as u32) }
}

impl W {
    #[doc = "Bits 0:31 - Alarm Value"]
    #[inline(always)]
    pub fn almv(&mut self) -> ALMV_W { ALMV_W { w: self } }
}