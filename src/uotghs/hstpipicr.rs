...
pub struct TXSTPIC_W<'a> { w: &'a mut W }
...
pub struct RXSTALLDIC_W<'a> { w: &'a mut W }
...
impl W {
    ...
    #[inline(always)]
    pub fn txstpic(&mut self) -> TXSTPIC_W { TXSTPIC_W { w: self } }
    ...
    #[inline(always)]
    pub fn rxstalldic(&mut self) -> RXSTALLDIC_W { RXSTALLDIC_W { w: self } }
