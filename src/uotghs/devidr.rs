...
pub struct SUSPEC_W<'a> { w: &'a mut W }
...
pub struct MSOFEC_W<'a> { w: &'a mut W }
...
pub struct SOFEC_W<'a> { w: &'a mut W }
...
pub struct EORSTEC_W<'a> { w: &'a mut W }
...
pub struct WAKEUPEC_W<'a> { w: &'a mut W }
...
pub struct EORSMEC_W<'a> { w: &'a mut W }
...
pub struct UPRSMEC_W<'a> { w: &'a mut W }
...
impl W {
    ...
    #[inline(always)]
    pub fn suspec(&mut self) -> SUSPEC_W { SUSPEC_W { w: self } }
    #[doc = "Bit 1 - Micro Start of Frame Interrupt Disable"]
    #[inline(always)]
    pub fn msofec(&mut self) -> MSOFEC_W { MSOFEC_W { w: self } }
    #[doc = "Bit 2 - Start of Frame Interrupt Disable"]
    #[inline(always)]
    pub fn sofec(&mut self) -> SOFEC_W { SOFEC_W { w: self } }
    #[doc = "Bit 3 - End of Reset Interrupt Disable"]
    #[inline(always)]
    pub fn eorstec(&mut self) -> EORSTEC_W { EORSTEC_W { w: self } }
    #[doc = "Bit 4 - Wake-Up Interrupt Disable"]
    #[inline(always)]
    pub fn wakeupec(&mut self) -> WAKEUPEC_W { WAKEUPEC_W { w: self } }
    #[doc = "Bit 5 - End of Resume Interrupt Disable"]
    #[inline(always)]
    pub fn eorsmec(&mut self) -> EORSMEC_W { EORSMEC_W { w: self } }
    #[doc = "Bit 6 - Upstream Resume Interrupt Disable"]
    #[inline(always)]
    pub fn uprsmec(&mut self) -> UPRSMEC_W { UPRSMEC_W { w: self } }
