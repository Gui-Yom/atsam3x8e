...
pub struct DATATGL_W<'a> { w: &'a mut W }
...
pub struct DATAPID_W<'a> { w: &'a mut W }
...
pub struct CRC16_W<'a> { w: &'a mut W }
...
pub struct COUNTER_W<'a> { w: &'a mut W }
...
impl R {
    ...
    #[inline(always)]
    pub fn datatgl(&self) -> DATATGL_R { DATATGL_R::new((self.bits & 0x01) != 0) }
    #[doc = "Bit 1 - Data PID Error"]
    #[inline(always)]
    pub fn datapid(&self) -> DATAPID_R { DATAPID_R::new(((self.bits >> 1) & 0x01) != 0) }
    #[doc = "Bit 2 - PID Error"]
    #[inline(always)]
    pub fn pid(&self) -> PID_R { PID_R::new(((self.bits >> 2) & 0x01) != 0) }
    #[doc = "Bit 3 - Time-Out Error"]
    #[inline(always)]
    pub fn timeout(&self) -> TIMEOUT_R { TIMEOUT_R::new(((self.bits >> 3) & 0x01) != 0) }
    #[doc = "Bit 4 - CRC16 Error"]
    #[inline(always)]
    pub fn crc16(&self) -> CRC16_R { CRC16_R::new(((self.bits >> 4) & 0x01) != 0) }
    #[doc = "Bits 5:6 - Error Counter"]
    #[inline(always)]
    pub fn counter(&self) -> COUNTER_R { COUNTER_R::new(((self.bits >> 5) & 0x03) as u8) }
}

impl W {
    #[doc = "Bit 0 - Data Toggle Error"]
    #[inline(always)]
    pub fn datatgl(&mut self) -> DATATGL_W { DATATGL_W { w: self } }
    #[doc = "Bit 1 - Data PID Error"]
    #[inline(always)]
    pub fn datapid(&mut self) -> DATAPID_W { DATAPID_W { w: self } }
    #[doc = "Bit 2 - PID Error"]
    #[inline(always)]
    ...
    #[doc = "Bit 4 - CRC16 Error"]
    #[inline(always)]
    pub fn crc16(&mut self) -> CRC16_W { CRC16_W { w: self } }
    #[doc = "Bits 5:6 - Error Counter"]
    #[inline(always)]
    pub fn counter(&mut self) -> COUNTER_W { COUNTER_W { w: self } }
}