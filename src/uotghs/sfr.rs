...
pub struct IDTIS_W<'a> { w: &'a mut W }
...
pub struct VBUSTIS_W<'a> { w: &'a mut W }
...
pub struct SRPIS_W<'a> { w: &'a mut W }
...
pub struct VBERRIS_W<'a> { w: &'a mut W }
...
pub struct BCERRIS_W<'a> { w: &'a mut W }
...
pub struct ROLEEXIS_W<'a> { w: &'a mut W }
...
pub struct HNPERRIS_W<'a> { w: &'a mut W }
...
pub struct STOIS_W<'a> { w: &'a mut W }
...
pub struct VBUSRQS_W<'a> { w: &'a mut W }
...
impl W {
    ...
    #[inline(always)]
    pub fn idtis(&mut self) -> IDTIS_W { IDTIS_W { w: self } }
    #[doc = "Bit 1 - VBus Transition Interrupt Set"]
    #[inline(always)]
    pub fn vbustis(&mut self) -> VBUSTIS_W { VBUSTIS_W { w: self } }
    #[doc = "Bit 2 - SRP Interrupt Set"]
    #[inline(always)]
    pub fn srpis(&mut self) -> SRPIS_W { SRPIS_W { w: self } }
    #[doc = "Bit 3 - VBus Error Interrupt Set"]
    #[inline(always)]
    pub fn vberris(&mut self) -> VBERRIS_W { VBERRIS_W { w: self } }
    #[doc = "Bit 4 - B-Connection Error Interrupt Set"]
    #[inline(always)]
    pub fn bcerris(&mut self) -> BCERRIS_W { BCERRIS_W { w: self } }
    #[doc = "Bit 5 - Role Exchange Interrupt Set"]
    #[inline(always)]
    pub fn roleexis(&mut self) -> ROLEEXIS_W { ROLEEXIS_W { w: self } }
    #[doc = "Bit 6 - HNP Error Interrupt Set"]
    #[inline(always)]
    pub fn hnperris(&mut self) -> HNPERRIS_W { HNPERRIS_W { w: self } }
    #[doc = "Bit 7 - Suspend Time-Out Interrupt Set"]
    #[inline(always)]
    pub fn stois(&mut self) -> STOIS_W { STOIS_W { w: self } }
    #[doc = "Bit 9 - VBus Request Set"]
    #[inline(always)]
    pub fn vbusrqs(&mut self) -> VBUSRQS_W { VBUSRQS_W { w: self } }
}