...
pub struct RXSTPEC_W<'a> { w: &'a mut W }
...
pub struct NAKOUTEC_W<'a> { w: &'a mut W }
...
pub struct NAKINEC_W<'a> { w: &'a mut W }
...
pub struct STALLEDEC_W<'a> { w: &'a mut W }
...
pub struct NYETDISC_W<'a> { w: &'a mut W }
...
pub struct STALLRQC_W<'a> { w: &'a mut W }
...
impl W {
    ...
    #[inline(always)]
    pub fn rxstpec(&mut self) -> RXSTPEC_W { RXSTPEC_W { w: self } }
    #[doc = "Bit 3 - NAKed OUT Interrupt Clear"]
    #[inline(always)]
    pub fn nakoutec(&mut self) -> NAKOUTEC_W { NAKOUTEC_W { w: self } }
    #[doc = "Bit 4 - NAKed IN Interrupt Clear"]
    #[inline(always)]
    pub fn nakinec(&mut self) -> NAKINEC_W { NAKINEC_W { w: self } }
    #[doc = "Bit 5 - Overflow Interrupt Clear"]
    #[inline(always)]
    pub fn overfec(&mut self) -> OVERFEC_W { OVERFEC_W { w: self } }
    #[doc = "Bit 6 - STALLed Interrupt Clear"]
    #[inline(always)]
    pub fn stalledec(&mut self) -> STALLEDEC_W { STALLEDEC_W { w: self } }
    ...
    #[inline(always)]
    pub fn nyetdisc(&mut self) -> NYETDISC_W { NYETDISC_W { w: self } }
    #[doc = "Bit 19 - STALL Request Clear"]
    #[inline(always)]
    pub fn stallrqc(&mut self) -> STALLRQC_W { STALLRQC_W { w: self } }
}