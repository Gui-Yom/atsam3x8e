...
pub struct SUSPS_W<'a> { w: &'a mut W }
...
pub struct MSOFS_W<'a> { w: &'a mut W }
...
pub struct EORSTS_W<'a> { w: &'a mut W }
...
pub struct WAKEUPS_W<'a> { w: &'a mut W }
...
pub struct EORSMS_W<'a> { w: &'a mut W }
...
pub struct UPRSMS_W<'a> { w: &'a mut W }
...
impl W {
    ...
    #[inline(always)]
    pub fn susps(&mut self) -> SUSPS_W { SUSPS_W { w: self } }
    #[doc = "Bit 1 - Micro Start of Frame Interrupt Set"]
    #[inline(always)]
    pub fn msofs(&mut self) -> MSOFS_W { MSOFS_W { w: self } }
    #[doc = "Bit 2 - Start of Frame Interrupt Set"]
    #[inline(always)]
    pub fn sofs(&mut self) -> SOFS_W { SOFS_W { w: self } }
    #[doc = "Bit 3 - End of Reset Interrupt Set"]
    #[inline(always)]
    pub fn eorsts(&mut self) -> EORSTS_W { EORSTS_W { w: self } }
    #[doc = "Bit 4 - Wake-Up Interrupt Set"]
    #[inline(always)]
    pub fn wakeups(&mut self) -> WAKEUPS_W { WAKEUPS_W { w: self } }
    #[doc = "Bit 5 - End of Resume Interrupt Set"]
    #[inline(always)]
    pub fn eorsms(&mut self) -> EORSMS_W { EORSMS_W { w: self } }
    #[doc = "Bit 6 - Upstream Resume Interrupt Set"]
    #[inline(always)]
    pub fn uprsms(&mut self) -> UPRSMS_W { UPRSMS_W { w: self } }
