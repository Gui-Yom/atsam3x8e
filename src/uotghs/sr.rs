...
#[repr(u8)]
pub enum SPEED_A { #[doc = "0: Full-Speed mode"] FULL_SPEED = 0, #[doc = "1: High-Speed mode"] HIGH_SPEED = 1, #[doc = "2: Low-Speed mode"] LOW_SPEED = 2 }

impl From<SPEED_A> for u8 {
    #[inline(always)]
    fn from(variant: SPEED_A) -> Self { variant as _ }
}
...
impl SPEED_R {
    ...
    #[inline(always)]
    pub fn is_full_speed(&self) -> bool { *self == SPEED_A::FULL_SPEED }
    #[doc = "Checks if the value of the field is `HIGH_SPEED`"]
    #[inline(always)]
    pub fn is_high_speed(&self) -> bool { *self == SPEED_A::HIGH_SPEED }
    #[doc = "Checks if the value of the field is `LOW_SPEED`"]
    #[inline(always)]
    pub fn is_low_speed(&self) -> bool { *self == SPEED_A::LOW_SPEED }
}
...
impl R {
    ...
    #[inline(always)]
    pub fn idti(&self) -> IDTI_R { IDTI_R::new((self.bits & 0x01) != 0) }
    #[doc = "Bit 1 - VBus Transition Interrupt"]
    #[inline(always)]
    pub fn vbusti(&self) -> VBUSTI_R { VBUSTI_R::new(((self.bits >> 1) & 0x01) != 0) }
    #[doc = "Bit 2 - SRP Interrupt"]
    #[inline(always)]
    pub fn srpi(&self) -> SRPI_R { SRPI_R::new(((self.bits >> 2) & 0x01) != 0) }
    #[doc = "Bit 3 - VBus Error Interrupt"]
    #[inline(always)]
    pub fn vberri(&self) -> VBERRI_R { VBERRI_R::new(((self.bits >> 3) & 0x01) != 0) }
    #[doc = "Bit 4 - B-Connection Error Interrupt"]
    #[inline(always)]
    pub fn bcerri(&self) -> BCERRI_R { BCERRI_R::new(((self.bits >> 4) & 0x01) != 0) }
    #[doc = "Bit 5 - Role Exchange Interrupt"]
    #[inline(always)]
    pub fn roleexi(&self) -> ROLEEXI_R { ROLEEXI_R::new(((self.bits >> 5) & 0x01) != 0) }
    #[doc = "Bit 6 - HNP Error Interrupt"]
    #[inline(always)]
    pub fn hnperri(&self) -> HNPERRI_R { HNPERRI_R::new(((self.bits >> 6) & 0x01) != 0) }
    #[doc = "Bit 7 - Suspend Time-Out Interrupt"]
    #[inline(always)]
    pub fn stoi(&self) -> STOI_R { STOI_R::new(((self.bits >> 7) & 0x01) != 0) }
    #[doc = "Bit 9 - VBus Request"]
    #[inline(always)]
    pub fn vbusrq(&self) -> VBUSRQ_R { VBUSRQ_R::new(((self.bits >> 9) & 0x01) != 0) }
    #[doc = "Bit 10 - UOTGID Pin State"]
    #[inline(always)]
    pub fn id(&self) -> ID_R { ID_R::new(((self.bits >> 10) & 0x01) != 0) }
    #[doc = "Bit 11 - VBus Level"]
    #[inline(always)]
    pub fn vbus(&self) -> VBUS_R { VBUS_R::new(((self.bits >> 11) & 0x01) != 0) }
    #[doc = "Bits 12:13 - Speed Status"]
    #[inline(always)]
    pub fn speed(&self) -> SPEED_R { SPEED_R::new(((self.bits >> 12) & 0x03) as u8) }
    #[doc = "Bit 14 - UTMI Clock Usable"]
    #[inline(always)]
    pub fn clkusable(&self) -> CLKUSABLE_R { CLKUSABLE_R::new(((self.bits >> 14) & 0x01) != 0) }
}