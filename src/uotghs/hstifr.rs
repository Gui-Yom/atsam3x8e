...
pub struct DCONNIS_W<'a> { w: &'a mut W }
...
pub struct DDISCIS_W<'a> { w: &'a mut W }
...
pub struct RSTIS_W<'a> { w: &'a mut W }
...
pub struct RSMEDIS_W<'a> { w: &'a mut W }
...
pub struct RXRSMIS_W<'a> { w: &'a mut W }
...
pub struct HSOFIS_W<'a> { w: &'a mut W }
...
pub struct HWUPIS_W<'a> { w: &'a mut W }
...
impl W {
    ...
    #[inline(always)]
    pub fn dconnis(&mut self) -> DCONNIS_W { DCONNIS_W { w: self } }
    #[doc = "Bit 1 - Device Disconnection Interrupt Set"]
    #[inline(always)]
    pub fn ddiscis(&mut self) -> DDISCIS_W { DDISCIS_W { w: self } }
    #[doc = "Bit 2 - USB Reset Sent Interrupt Set"]
    #[inline(always)]
    pub fn rstis(&mut self) -> RSTIS_W { RSTIS_W { w: self } }
    #[doc = "Bit 3 - Downstream Resume Sent Interrupt Set"]
    #[inline(always)]
    pub fn rsmedis(&mut self) -> RSMEDIS_W { RSMEDIS_W { w: self } }
    #[doc = "Bit 4 - Upstream Resume Received Interrupt Set"]
    #[inline(always)]
    pub fn rxrsmis(&mut self) -> RXRSMIS_W { RXRSMIS_W { w: self } }
    #[doc = "Bit 5 - Host Start of Frame Interrupt Set"]
    #[inline(always)]
    pub fn hsofis(&mut self) -> HSOFIS_W { HSOFIS_W { w: self } }
    #[doc = "Bit 6 - Host Wake-Up Interrupt Set"]
    #[inline(always)]
    pub fn hwupis(&mut self) -> HWUPIS_W { HWUPIS_W { w: self } }
