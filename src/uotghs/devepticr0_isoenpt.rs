...
pub struct HBISOINERRIC_W<'a> { w: &'a mut W }
...
pub struct HBISOFLUSHIC_W<'a> { w: &'a mut W }
...
impl W {
    ...
    #[inline(always)]
    pub fn hbisoinerric(&mut self) -> HBISOINERRIC_W { HBISOINERRIC_W { w: self } }
    #[doc = "Bit 4 - High Bandwidth Isochronous IN Flush Interrupt Clear"]
    #[inline(always)]
    pub fn hbisoflushic(&mut self) -> HBISOFLUSHIC_W { HBISOFLUSHIC_W { w: self } }
