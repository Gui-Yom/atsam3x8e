...
pub struct TXINIC_W<'a> { w: &'a mut W }
...
pub struct RXOUTIC_W<'a> { w: &'a mut W }
...
pub struct RXSTPIC_W<'a> { w: &'a mut W }
...
pub struct NAKOUTIC_W<'a> { w: &'a mut W }
...
pub struct NAKINIC_W<'a> { w: &'a mut W }
...
pub struct STALLEDIC_W<'a> { w: &'a mut W }
...
pub struct SHORTPACKETC_W<'a> { w: &'a mut W }
...
impl W {
    ...
    #[inline(always)]
    pub fn txinic(&mut self) -> TXINIC_W { TXINIC_W { w: self } }
    #[doc = "Bit 1 - Received OUT Data Interrupt Clear"]
    #[inline(always)]
    pub fn rxoutic(&mut self) -> RXOUTIC_W { RXOUTIC_W { w: self } }
    #[doc = "Bit 2 - Received SETUP Interrupt Clear"]
    #[inline(always)]
    pub fn rxstpic(&mut self) -> RXSTPIC_W { RXSTPIC_W { w: self } }
    #[doc = "Bit 3 - NAKed OUT Interrupt Clear"]
    #[inline(always)]
    pub fn nakoutic(&mut self) -> NAKOUTIC_W { NAKOUTIC_W { w: self } }
    #[doc = "Bit 4 - NAKed IN Interrupt Clear"]
    #[inline(always)]
    pub fn nakinic(&mut self) -> NAKINIC_W { NAKINIC_W { w: self } }
    #[doc = "Bit 5 - Overflow Interrupt Clear"]
    #[inline(always)]
    pub fn overfic(&mut self) -> OVERFIC_W { OVERFIC_W { w: self } }
    #[doc = "Bit 6 - STALLed Interrupt Clear"]
    #[inline(always)]
    pub fn stalledic(&mut self) -> STALLEDIC_W { STALLEDIC_W { w: self } }
    #[doc = "Bit 7 - Short Packet Interrupt Clear"]
    #[inline(always)]
    pub fn shortpacketc(&mut self) -> SHORTPACKETC_W { SHORTPACKETC_W { w: self } }
}