...
pub struct RESET_W<'a> { w: &'a mut W }
...
pub struct RESUME_W<'a> { w: &'a mut W }
...
#[repr(u8)]
pub enum SPDCONF_A { #[doc = "0: The host starts in full-speed mode and performs a high-speed reset to switch to the high-speed mode if the downstream peripheral is high-speed capable."] NORMAL = 0, #[doc = "1: For a better consumption, if high-speed is not needed."] LOW_POWER = 1, #[doc = "2: Forced high speed."] HIGH_SPEED = 2, #[doc = "3: The host remains to full-speed mode whatever the peripheral speed capability."] FORCED_FS = 3 }
...
impl R {
    ...
    #[inline(always)]
    pub fn sofe(&self) -> SOFE_R { SOFE_R::new(((self.bits >> 8) & 0x01) != 0) }
    #[doc = "Bit 9 - Send USB Reset"]
    #[inline(always)]
    pub fn reset(&self) -> RESET_R { RESET_R::new(((self.bits >> 9) & 0x01) != 0) }
    #[doc = "Bit 10 - Send USB Resume"]
    #[inline(always)]
    pub fn resume(&self) -> RESUME_R { RESUME_R::new(((self.bits >> 10) & 0x01) != 0) }
    #[doc = "Bits 12:13 - Mode Configuration"]
    #[inline(always)]
    pub fn spdconf(&self) -> SPDCONF_R { SPDCONF_R::new(((self.bits >> 12) & 0x03) as u8) }
}

impl W {
    #[doc = "Bit 8 - Start of Frame Generation Enable"]
    #[inline(always)]
    pub fn sofe(&mut self) -> SOFE_W { SOFE_W { w: self } }
    #[doc = "Bit 9 - Send USB Reset"]
    #[inline(always)]
    pub fn reset(&mut self) -> RESET_W { RESET_W { w: self } }
    #[doc = "Bit 10 - Send USB Resume"]
    #[inline(always)]
    pub fn resume(&mut self) -> RESUME_W { RESUME_W { w: self } }
    #[doc = "Bits 12:13 - Mode Configuration"]
    #[inline(always)]
