...
pub struct CHANN_ACT_W<'a> { w: &'a mut W }
...
pub struct END_TR_ST_W<'a> { w: &'a mut W }
...
pub struct END_BF_ST_W<'a> { w: &'a mut W }
...
pub struct DESC_LDST_W<'a> { w: &'a mut W }
...
pub struct BUFF_COUNT_W<'a> { w: &'a mut W }
...
impl R {
    ...
    #[inline(always)]
    pub fn chann_act(&self) -> CHANN_ACT_R { CHANN_ACT_R::new(((self.bits >> 1) & 0x01) != 0) }
    #[doc = "Bit 4 - End of Channel Transfer Status"]
    #[inline(always)]
    pub fn end_tr_st(&self) -> END_TR_ST_R { END_TR_ST_R::new(((self.bits >> 4) & 0x01) != 0) }
    #[doc = "Bit 5 - End of Channel Buffer Status"]
    #[inline(always)]
    pub fn end_bf_st(&self) -> END_BF_ST_R { END_BF_ST_R::new(((self.bits >> 5) & 0x01) != 0) }
    #[doc = "Bit 6 - Descriptor Loaded Status"]
    #[inline(always)]
    pub fn desc_ldst(&self) -> DESC_LDST_R { DESC_LDST_R::new(((self.bits >> 6) & 0x01) != 0) }
    #[doc = "Bits 16:31 - Buffer Byte Count"]
    #[inline(always)]
    pub fn buff_count(&self) -> BUFF_COUNT_R { BUFF_COUNT_R::new(((self.bits >> 16) & 0xffff) as u16) }
}
...
impl W {
    ...
    #[doc = "Bit 1 - Channel Active Status"]
    #[inline(always)]
    pub fn chann_act(&mut self) -> CHANN_ACT_W { CHANN_ACT_W { w: self } }
    #[doc = "Bit 4 - End of Channel Transfer Status"]
    #[inline(always)]
    pub fn end_tr_st(&mut self) -> END_TR_ST_W { END_TR_ST_W { w: self } }
    #[doc = "Bit 5 - End of Channel Buffer Status"]
    #[inline(always)]
    pub fn end_bf_st(&mut self) -> END_BF_ST_W { END_BF_ST_W { w: self } }
    #[doc = "Bit 6 - Descriptor Loaded Status"]
    #[inline(always)]
    pub fn desc_ldst(&mut self) -> DESC_LDST_W { DESC_LDST_W { w: self } }
    #[doc = "Bits 16:31 - Buffer Byte Count"]
    #[inline(always)]
    pub fn buff_count(&mut self) -> BUFF_COUNT_W { BUFF_COUNT_W { w: self } }
}