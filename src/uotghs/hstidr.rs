...
pub struct DCONNIEC_W<'a> { w: &'a mut W }
...
pub struct DDISCIEC_W<'a> { w: &'a mut W }
...
pub struct RSTIEC_W<'a> { w: &'a mut W }
...
pub struct RSMEDIEC_W<'a> { w: &'a mut W }
...
pub struct RXRSMIEC_W<'a> { w: &'a mut W }
...
pub struct HSOFIEC_W<'a> { w: &'a mut W }
...
pub struct HWUPIEC_W<'a> { w: &'a mut W }
...
impl W {
    ...
    #[inline(always)]
    pub fn dconniec(&mut self) -> DCONNIEC_W { DCONNIEC_W { w: self } }
    #[doc = "Bit 1 - Device Disconnection Interrupt Disable"]
    #[inline(always)]
    pub fn ddisciec(&mut self) -> DDISCIEC_W { DDISCIEC_W { w: self } }
    #[doc = "Bit 2 - USB Reset Sent Interrupt Disable"]
    #[inline(always)]
    pub fn rstiec(&mut self) -> RSTIEC_W { RSTIEC_W { w: self } }
    #[doc = "Bit 3 - Downstream Resume Sent Interrupt Disable"]
    #[inline(always)]
    pub fn rsmediec(&mut self) -> RSMEDIEC_W { RSMEDIEC_W { w: self } }
    #[doc = "Bit 4 - Upstream Resume Received Interrupt Disable"]
    #[inline(always)]
    pub fn rxrsmiec(&mut self) -> RXRSMIEC_W { RXRSMIEC_W { w: self } }
    #[doc = "Bit 5 - Host Start of Frame Interrupt Disable"]
    #[inline(always)]
    pub fn hsofiec(&mut self) -> HSOFIEC_W { HSOFIEC_W { w: self } }
    #[doc = "Bit 6 - Host Wake-Up Interrupt Disable"]
    #[inline(always)]
    pub fn hwupiec(&mut self) -> HWUPIEC_W { HWUPIEC_W { w: self } }
