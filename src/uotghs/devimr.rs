...
impl R {
    ...
    #[inline(always)]
    pub fn suspe(&self) -> SUSPE_R { SUSPE_R::new((self.bits & 0x01) != 0) }
    #[doc = "Bit 1 - Micro Start of Frame Interrupt Mask"]
    #[inline(always)]
    pub fn msofe(&self) -> MSOFE_R { MSOFE_R::new(((self.bits >> 1) & 0x01) != 0) }
    #[doc = "Bit 2 - Start of Frame Interrupt Mask"]
    #[inline(always)]
    pub fn sofe(&self) -> SOFE_R { SOFE_R::new(((self.bits >> 2) & 0x01) != 0) }
    #[doc = "Bit 3 - End of Reset Interrupt Mask"]
    #[inline(always)]
    pub fn eorste(&self) -> EORSTE_R { EORSTE_R::new(((self.bits >> 3) & 0x01) != 0) }
    #[doc = "Bit 4 - Wake-Up Interrupt Mask"]
    #[inline(always)]
    pub fn wakeupe(&self) -> WAKEUPE_R { WAKEUPE_R::new(((self.bits >> 4) & 0x01) != 0) }
    #[doc = "Bit 5 - End of Resume Interrupt Mask"]
    #[inline(always)]
    pub fn eorsme(&self) -> EORSME_R { EORSME_R::new(((self.bits >> 5) & 0x01) != 0) }
    #[doc = "Bit 6 - Upstream Resume Interrupt Mask"]
    #[inline(always)]
    pub fn uprsme(&self) -> UPRSME_R { UPRSME_R::new(((self.bits >> 6) & 0x01) != 0) }
    #[doc = "Bit 12 - Endpoint 0 Interrupt Mask"]
    #[inline(always)]
    pub fn pep_0(&self) -> PEP_0_R { PEP_0_R::new(((self.bits >> 12) & 0x01) != 0) }
    #[doc = "Bit 13 - Endpoint 1 Interrupt Mask"]
    #[inline(always)]
    pub fn pep_1(&self) -> PEP_1_R { PEP_1_R::new(((self.bits >> 13) & 0x01) != 0) }
    #[doc = "Bit 14 - Endpoint 2 Interrupt Mask"]
    #[inline(always)]
    pub fn pep_2(&self) -> PEP_2_R { PEP_2_R::new(((self.bits >> 14) & 0x01) != 0) }
    #[doc = "Bit 15 - Endpoint 3 Interrupt Mask"]
    #[inline(always)]
    pub fn pep_3(&self) -> PEP_3_R { PEP_3_R::new(((self.bits >> 15) & 0x01) != 0) }
    #[doc = "Bit 16 - Endpoint 4 Interrupt Mask"]
    #[inline(always)]
    pub fn pep_4(&self) -> PEP_4_R { PEP_4_R::new(((self.bits >> 16) & 0x01) != 0) }
    #[doc = "Bit 17 - Endpoint 5 Interrupt Mask"]
    #[inline(always)]
    pub fn pep_5(&self) -> PEP_5_R { PEP_5_R::new(((self.bits >> 17) & 0x01) != 0) }
    #[doc = "Bit 18 - Endpoint 6 Interrupt Mask"]
    #[inline(always)]
    pub fn pep_6(&self) -> PEP_6_R { PEP_6_R::new(((self.bits >> 18) & 0x01) != 0) }
    #[doc = "Bit 19 - Endpoint 7 Interrupt Mask"]
    #[inline(always)]
    pub fn pep_7(&self) -> PEP_7_R { PEP_7_R::new(((self.bits >> 19) & 0x01) != 0) }
    #[doc = "Bit 20 - Endpoint 8 Interrupt Mask"]
    #[inline(always)]
    pub fn pep_8(&self) -> PEP_8_R { PEP_8_R::new(((self.bits >> 20) & 0x01) != 0) }
    #[doc = "Bit 21 - Endpoint 9 Interrupt Mask"]
    #[inline(always)]
    pub fn pep_9(&self) -> PEP_9_R { PEP_9_R::new(((self.bits >> 21) & 0x01) != 0) }
