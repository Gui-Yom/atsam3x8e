...
pub struct IDTIC_W<'a> { w: &'a mut W }
...
pub struct VBUSTIC_W<'a> { w: &'a mut W }
...
pub struct SRPIC_W<'a> { w: &'a mut W }
...
pub struct VBERRIC_W<'a> { w: &'a mut W }
...
pub struct BCERRIC_W<'a> { w: &'a mut W }
...
pub struct ROLEEXIC_W<'a> { w: &'a mut W }
...
pub struct HNPERRIC_W<'a> { w: &'a mut W }
...
pub struct STOIC_W<'a> { w: &'a mut W }
...
pub struct VBUSRQC_W<'a> { w: &'a mut W }
...
impl W {
    ...
    #[inline(always)]
    pub fn idtic(&mut self) -> IDTIC_W { IDTIC_W { w: self } }
    #[doc = "Bit 1 - VBus Transition Interrupt Clear"]
    #[inline(always)]
    pub fn vbustic(&mut self) -> VBUSTIC_W { VBUSTIC_W { w: self } }
    #[doc = "Bit 2 - SRP Interrupt Clear"]
    #[inline(always)]
    pub fn srpic(&mut self) -> SRPIC_W { SRPIC_W { w: self } }
    #[doc = "Bit 3 - VBus Error Interrupt Clear"]
    #[inline(always)]
    pub fn vberric(&mut self) -> VBERRIC_W { VBERRIC_W { w: self } }
    #[doc = "Bit 4 - B-Connection Error Interrupt Clear"]
    #[inline(always)]
    pub fn bcerric(&mut self) -> BCERRIC_W { BCERRIC_W { w: self } }
    #[doc = "Bit 5 - Role Exchange Interrupt Clear"]
    #[inline(always)]
    pub fn roleexic(&mut self) -> ROLEEXIC_W { ROLEEXIC_W { w: self } }
    #[doc = "Bit 6 - HNP Error Interrupt Clear"]
    #[inline(always)]
    pub fn hnperric(&mut self) -> HNPERRIC_W { HNPERRIC_W { w: self } }
    #[doc = "Bit 7 - Suspend Time-Out Interrupt Clear"]
    #[inline(always)]
    pub fn stoic(&mut self) -> STOIC_W { STOIC_W { w: self } }
    #[doc = "Bit 9 - VBus Request Clear"]
    #[inline(always)]
    pub fn vbusrqc(&mut self) -> VBUSRQC_W { VBUSRQC_W { w: self } }
}