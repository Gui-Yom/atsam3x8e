...
pub struct RegisterBlock {
    ...
    #[doc = "0x18 - Receiver Holding Register"] pub rhr: RHR,
    #[doc = "0x1c - Transmitter Holding Register"] pub thr: THR,
    #[doc = "0x20 - Baud Rate Generator Register"] pub brgr: BRGR,
    #[doc = "0x24 - Receiver Time-out Register"] pub rtor: RTOR,
    #[doc = "0x28 - Transmitter Timeguard Register"] pub ttgr: TTGR,
    _reserved11: [u8; 20usize],
    #[doc = "0x40 - FI DI Ratio Register"] pub fidi: FIDI,
    #[doc = "0x44 - Number of Errors Register"] pub ner: NER,
    _reserved13: [u8; 4usize],
    #[doc = "0x4c - IrDA Filter Register"] pub if_: IF,
    #[doc = "0x50 - Manchester Encoder Decoder Register"] pub man: MAN,
    #[doc = "0x54 - LIN Mode Register"] pub linmr: LINMR,
    #[doc = "0x58 - LIN Identifier Register"] pub linir: LINIR,
    _reserved17: [u8; 136usize],
    #[doc = "0xe4 - Write Protect Mode Register"] pub wpmr: WPMR,
    #[doc = "0xe8 - Write Protect Status Register"] pub wpsr: WPSR,
    _reserved19: [u8; 20usize],
    #[doc = "0x100 - Receive Pointer Register"] pub rpr: RPR,
    #[doc = "0x104 - Receive Counter Register"] pub rcr: RCR,
    #[doc = "0x108 - Transmit Pointer Register"] pub tpr: TPR,
    #[doc = "0x10c - Transmit Counter Register"] pub tcr: TCR,
    #[doc = "0x110 - Receive Next Pointer Register"] pub rnpr: RNPR,
    #[doc = "0x114 - Receive Next Counter Register"] pub rncr: RNCR,
...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub fn cr_spi_mode(&self) -> &CR_SPI_MODE { unsafe { &*(((self as *const Self) as *const u8).add(0usize) as *const CR_SPI_MODE) } }
    #[doc = "0x00 - Control Register"]
    #[inline(always)]
    pub fn cr_spi_mode_mut(&self) -> &mut CR_SPI_MODE { unsafe { &mut *(((self as *const Self) as *mut u8).add(0usize) as *mut CR_SPI_MODE) } }
    #[doc = "0x00 - Control Register"]
    #[inline(always)]
    pub fn cr(&self) -> &CR { unsafe { &*(((self as *const Self) as *const u8).add(0usize) as *const CR) } }
    #[doc = "0x00 - Control Register"]
    #[inline(always)]
    pub fn cr_mut(&self) -> &mut CR { unsafe { &mut *(((self as *const Self) as *mut u8).add(0usize) as *mut CR) } }
    #[doc = "0x04 - Mode Register"]
    #[inline(always)]
    pub fn mr_spi_mode(&self) -> &MR_SPI_MODE { unsafe { &*(((self as *const Self) as *const u8).add(4usize) as *const MR_SPI_MODE) } }
    #[doc = "0x04 - Mode Register"]
    #[inline(always)]
    pub fn mr_spi_mode_mut(&self) -> &mut MR_SPI_MODE { unsafe { &mut *(((self as *const Self) as *mut u8).add(4usize) as *mut MR_SPI_MODE) } }
    #[doc = "0x04 - Mode Register"]
    #[inline(always)]
    pub fn mr(&self) -> &MR { unsafe { &*(((self as *const Self) as *const u8).add(4usize) as *const MR) } }
    #[doc = "0x04 - Mode Register"]
    #[inline(always)]
    pub fn mr_mut(&self) -> &mut MR { unsafe { &mut *(((self as *const Self) as *mut u8).add(4usize) as *mut MR) } }
    #[doc = "0x08 - Interrupt Enable Register"]
    #[inline(always)]
    pub fn ier_lin_mode(&self) -> &IER_LIN_MODE { unsafe { &*(((self as *const Self) as *const u8).add(8usize) as *const IER_LIN_MODE) } }
    #[doc = "0x08 - Interrupt Enable Register"]
    #[inline(always)]
    pub fn ier_lin_mode_mut(&self) -> &mut IER_LIN_MODE { unsafe { &mut *(((self as *const Self) as *mut u8).add(8usize) as *mut IER_LIN_MODE) } }
    #[doc = "0x08 - Interrupt Enable Register"]
    #[inline(always)]
    pub fn ier_spi_mode(&self) -> &IER_SPI_MODE { unsafe { &*(((self as *const Self) as *const u8).add(8usize) as *const IER_SPI_MODE) } }
    #[doc = "0x08 - Interrupt Enable Register"]
    #[inline(always)]
    pub fn ier_spi_mode_mut(&self) -> &mut IER_SPI_MODE { unsafe { &mut *(((self as *const Self) as *mut u8).add(8usize) as *mut IER_SPI_MODE) } }
    #[doc = "0x08 - Interrupt Enable Register"]
    #[inline(always)]
    pub fn ier(&self) -> &IER { unsafe { &*(((self as *const Self) as *const u8).add(8usize) as *const IER) } }
    #[doc = "0x08 - Interrupt Enable Register"]
    #[inline(always)]
    pub fn ier_mut(&self) -> &mut IER { unsafe { &mut *(((self as *const Self) as *mut u8).add(8usize) as *mut IER) } }
    #[doc = "0x0c - Interrupt Disable Register"]
    #[inline(always)]
    pub fn idr_lin_mode(&self) -> &IDR_LIN_MODE { unsafe { &*(((self as *const Self) as *const u8).add(12usize) as *const IDR_LIN_MODE) } }
    #[doc = "0x0c - Interrupt Disable Register"]
    #[inline(always)]
    pub fn idr_lin_mode_mut(&self) -> &mut IDR_LIN_MODE { unsafe { &mut *(((self as *const Self) as *mut u8).add(12usize) as *mut IDR_LIN_MODE) } }
    #[doc = "0x0c - Interrupt Disable Register"]
    #[inline(always)]
    pub fn idr_spi_mode(&self) -> &IDR_SPI_MODE { unsafe { &*(((self as *const Self) as *const u8).add(12usize) as *const IDR_SPI_MODE) } }
    #[doc = "0x0c - Interrupt Disable Register"]
    #[inline(always)]
    pub fn idr_spi_mode_mut(&self) -> &mut IDR_SPI_MODE { unsafe { &mut *(((self as *const Self) as *mut u8).add(12usize) as *mut IDR_SPI_MODE) } }
    #[doc = "0x0c - Interrupt Disable Register"]
    #[inline(always)]
    pub fn idr(&self) -> &IDR { unsafe { &*(((self as *const Self) as *const u8).add(12usize) as *const IDR) } }
    #[doc = "0x0c - Interrupt Disable Register"]
    #[inline(always)]
    pub fn idr_mut(&self) -> &mut IDR { unsafe { &mut *(((self as *const Self) as *mut u8).add(12usize) as *mut IDR) } }
    #[doc = "0x10 - Interrupt Mask Register"]
    #[inline(always)]
    pub fn imr_lin_mode(&self) -> &IMR_LIN_MODE { unsafe { &*(((self as *const Self) as *const u8).add(16usize) as *const IMR_LIN_MODE) } }
    #[doc = "0x10 - Interrupt Mask Register"]
    #[inline(always)]
    pub fn imr_lin_mode_mut(&self) -> &mut IMR_LIN_MODE { unsafe { &mut *(((self as *const Self) as *mut u8).add(16usize) as *mut IMR_LIN_MODE) } }
    #[doc = "0x10 - Interrupt Mask Register"]
    #[inline(always)]
    pub fn imr_spi_mode(&self) -> &IMR_SPI_MODE { unsafe { &*(((self as *const Self) as *const u8).add(16usize) as *const IMR_SPI_MODE) } }
    #[doc = "0x10 - Interrupt Mask Register"]
    #[inline(always)]
    pub fn imr_spi_mode_mut(&self) -> &mut IMR_SPI_MODE { unsafe { &mut *(((self as *const Self) as *mut u8).add(16usize) as *mut IMR_SPI_MODE) } }
    #[doc = "0x10 - Interrupt Mask Register"]
    #[inline(always)]
    pub fn imr(&self) -> &IMR { unsafe { &*(((self as *const Self) as *const u8).add(16usize) as *const IMR) } }
    #[doc = "0x10 - Interrupt Mask Register"]
    #[inline(always)]
    pub fn imr_mut(&self) -> &mut IMR { unsafe { &mut *(((self as *const Self) as *mut u8).add(16usize) as *mut IMR) } }
    #[doc = "0x14 - Channel Status Register"]
    #[inline(always)]
    pub fn csr_lin_mode(&self) -> &CSR_LIN_MODE { unsafe { &*(((self as *const Self) as *const u8).add(20usize) as *const CSR_LIN_MODE) } }
    #[doc = "0x14 - Channel Status Register"]
    #[inline(always)]
    pub fn csr_lin_mode_mut(&self) -> &mut CSR_LIN_MODE { unsafe { &mut *(((self as *const Self) as *mut u8).add(20usize) as *mut CSR_LIN_MODE) } }
    #[doc = "0x14 - Channel Status Register"]
    #[inline(always)]
    pub fn csr_spi_mode(&self) -> &CSR_SPI_MODE { unsafe { &*(((self as *const Self) as *const u8).add(20usize) as *const CSR_SPI_MODE) } }
    #[doc = "0x14 - Channel Status Register"]
    #[inline(always)]
    pub fn csr_spi_mode_mut(&self) -> &mut CSR_SPI_MODE { unsafe { &mut *(((self as *const Self) as *mut u8).add(20usize) as *mut CSR_SPI_MODE) } }
    #[doc = "0x14 - Channel Status Register"]
    #[inline(always)]
    pub fn csr(&self) -> &CSR { unsafe { &*(((self as *const Self) as *const u8).add(20usize) as *const CSR) } }
    #[doc = "0x14 - Channel Status Register"]
    #[inline(always)]
    pub fn csr_mut(&self) -> &mut CSR { unsafe { &mut *(((self as *const Self) as *mut u8).add(20usize) as *mut CSR) } }
}
