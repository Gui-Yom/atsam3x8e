...
pub struct URSTEN_W<'a> { w: &'a mut W }
...
pub struct URSTIEN_W<'a> { w: &'a mut W }
...
pub struct ERSTL_W<'a> { w: &'a mut W }
...
impl R {
    ...
    #[inline(always)]
    pub fn ursten(&self) -> URSTEN_R { URSTEN_R::new((self.bits & 0x01) != 0) }
    #[doc = "Bit 4 - User Reset Interrupt Enable"]
    #[inline(always)]
    pub fn urstien(&self) -> URSTIEN_R { URSTIEN_R::new(((self.bits >> 4) & 0x01) != 0) }
    #[doc = "Bits 8:11 - External Reset Length"]
    #[inline(always)]
    pub fn erstl(&self) -> ERSTL_R { ERSTL_R::new(((self.bits >> 8) & 0x0f) as u8) }
...
impl W {
    #[doc = "Bit 0 - User Reset Enable"]
    #[inline(always)]
    pub fn ursten(&mut self) -> URSTEN_W { URSTEN_W { w: self } }
    #[doc = "Bit 4 - User Reset Interrupt Enable"]
    #[inline(always)]
    pub fn urstien(&mut self) -> URSTIEN_W { URSTIEN_W { w: self } }
    #[doc = "Bits 8:11 - External Reset Length"]
    #[inline(always)]
    pub fn erstl(&mut self) -> ERSTL_W { ERSTL_W { w: self } }
    #[doc = "Bits 24:31 - Password"]
    #[inline(always)]
