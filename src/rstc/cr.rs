...
pub struct PROCRST_W<'a> { w: &'a mut W }
...
pub struct PERRST_W<'a> { w: &'a mut W }
...
pub struct EXTRST_W<'a> { w: &'a mut W }
...
impl W {
    ...
    #[inline(always)]
    pub fn procrst(&mut self) -> PROCRST_W { PROCRST_W { w: self } }
    #[doc = "Bit 2 - Peripheral Reset"]
    #[inline(always)]
    pub fn perrst(&mut self) -> PERRST_W { PERRST_W { w: self } }
    #[doc = "Bit 3 - External Reset"]
    #[inline(always)]
    pub fn extrst(&mut self) -> EXTRST_W { EXTRST_W { w: self } }
