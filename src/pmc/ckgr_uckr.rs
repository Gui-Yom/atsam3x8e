...
impl crate::ResetValue for super::CKGR_UCKR {
    #[inline(always)]
    fn reset_value() -> Self::Ux { 0x1020_0800 }
}
...
pub struct UPLLEN_W<'a> { w: &'a mut W }
...
pub struct UPLLCOUNT_W<'a> { w: &'a mut W }
...
impl R {
    ...
    #[inline(always)]
    pub fn upllen(&self) -> UPLLEN_R { UPLLEN_R::new(((self.bits >> 16) & 0x01) != 0) }
    #[doc = "Bits 20:23 - UTMI PLL Start-up Time"]
    #[inline(always)]
    pub fn upllcount(&self) -> UPLLCOUNT_R { UPLLCOUNT_R::new(((self.bits >> 20) & 0x0f) as u8) }
}

impl W {
    #[doc = "Bit 16 - UTMI PLL Enable"]
    #[inline(always)]
    pub fn upllen(&mut self) -> UPLLEN_W { UPLLEN_W { w: self } }
    #[doc = "Bits 20:23 - UTMI PLL Start-up Time"]
    #[inline(always)]
    pub fn upllcount(&mut self) -> UPLLCOUNT_W { UPLLCOUNT_W { w: self } }
}