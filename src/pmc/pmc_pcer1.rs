...
pub struct PID32_W<'a> { w: &'a mut W }
...
pub struct PID33_W<'a> { w: &'a mut W }
...
pub struct PID34_W<'a> { w: &'a mut W }
...
pub struct PID35_W<'a> { w: &'a mut W }
...
pub struct PID36_W<'a> { w: &'a mut W }
...
pub struct PID37_W<'a> { w: &'a mut W }
...
pub struct PID38_W<'a> { w: &'a mut W }
...
pub struct PID39_W<'a> { w: &'a mut W }
...
pub struct PID40_W<'a> { w: &'a mut W }
...
pub struct PID41_W<'a> { w: &'a mut W }
...
pub struct PID42_W<'a> { w: &'a mut W }
...
pub struct PID43_W<'a> { w: &'a mut W }
...
pub struct PID44_W<'a> { w: &'a mut W }
...
impl W {
    ...
    #[inline(always)]
    pub fn pid32(&mut self) -> PID32_W { PID32_W { w: self } }
    #[doc = "Bit 1 - Peripheral Clock 33 Enable"]
    #[inline(always)]
    pub fn pid33(&mut self) -> PID33_W { PID33_W { w: self } }
    #[doc = "Bit 2 - Peripheral Clock 34 Enable"]
    #[inline(always)]
    pub fn pid34(&mut self) -> PID34_W { PID34_W { w: self } }
    #[doc = "Bit 3 - Peripheral Clock 35 Enable"]
    #[inline(always)]
    pub fn pid35(&mut self) -> PID35_W { PID35_W { w: self } }
    #[doc = "Bit 4 - Peripheral Clock 36 Enable"]
    #[inline(always)]
    pub fn pid36(&mut self) -> PID36_W { PID36_W { w: self } }
    #[doc = "Bit 5 - Peripheral Clock 37 Enable"]
    #[inline(always)]
    pub fn pid37(&mut self) -> PID37_W { PID37_W { w: self } }
    #[doc = "Bit 6 - Peripheral Clock 38 Enable"]
    #[inline(always)]
    pub fn pid38(&mut self) -> PID38_W { PID38_W { w: self } }
    #[doc = "Bit 7 - Peripheral Clock 39 Enable"]
    #[inline(always)]
    pub fn pid39(&mut self) -> PID39_W { PID39_W { w: self } }
    #[doc = "Bit 8 - Peripheral Clock 40 Enable"]
    #[inline(always)]
    pub fn pid40(&mut self) -> PID40_W { PID40_W { w: self } }
    #[doc = "Bit 9 - Peripheral Clock 41 Enable"]
    #[inline(always)]
    pub fn pid41(&mut self) -> PID41_W { PID41_W { w: self } }
    #[doc = "Bit 10 - Peripheral Clock 42 Enable"]
    #[inline(always)]
    pub fn pid42(&mut self) -> PID42_W { PID42_W { w: self } }
    #[doc = "Bit 11 - Peripheral Clock 43 Enable"]
    #[inline(always)]
    pub fn pid43(&mut self) -> PID43_W { PID43_W { w: self } }
    #[doc = "Bit 12 - Peripheral Clock 44 Enable"]
    #[inline(always)]
    pub fn pid44(&mut self) -> PID44_W { PID44_W { w: self } }
}