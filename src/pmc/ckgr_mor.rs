...
pub struct MOSCXTEN_W<'a> { w: &'a mut W }
...
pub struct MOSCXTBY_W<'a> { w: &'a mut W }
...
pub struct MOSCRCEN_W<'a> { w: &'a mut W }
...
#[repr(u8)]
pub enum MOSCRCF_A { #[doc = "0: The Fast RC Oscillator Frequency is at 4 MHz (default)"] _4_MHZ = 0, #[doc = "1: The Fast RC Oscillator Frequency is at 8 MHz"] _8_MHZ = 1, #[doc = "2: The Fast RC Oscillator Frequency is at 12 MHz"] _12_MHZ = 2 }

impl From<MOSCRCF_A> for u8 {
    #[inline(always)]
    fn from(variant: MOSCRCF_A) -> Self { variant as _ }
}
...
impl MOSCRCF_R {
    ...
    #[inline(always)]
    pub fn is_4_mhz(&self) -> bool { *self == MOSCRCF_A::_4_MHZ }
    #[doc = "Checks if the value of the field is `_8_MHZ`"]
    #[inline(always)]
    pub fn is_8_mhz(&self) -> bool { *self == MOSCRCF_A::_8_MHZ }
    #[doc = "Checks if the value of the field is `_12_MHZ`"]
    #[inline(always)]
    pub fn is_12_mhz(&self) -> bool { *self == MOSCRCF_A::_12_MHZ }
}

#[doc = "Write proxy for field `MOSCRCF`"]
pub struct MOSCRCF_W<'a> { w: &'a mut W }

impl<'a> MOSCRCF_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: MOSCRCF_A) -> &'a mut W { unsafe { self.bits(variant.into()) } }
    #[doc = "The Fast RC Oscillator Frequency is at 4 MHz (default)"]
    #[inline(always)]
    pub fn _4_mhz(self) -> &'a mut W { self.variant(MOSCRCF_A::_4_MHZ) }
    #[doc = "The Fast RC Oscillator Frequency is at 8 MHz"]
    #[inline(always)]
    pub fn _8_mhz(self) -> &'a mut W { self.variant(MOSCRCF_A::_8_MHZ) }
    #[doc = "The Fast RC Oscillator Frequency is at 12 MHz"]
    #[inline(always)]
    pub fn _12_mhz(self) -> &'a mut W { self.variant(MOSCRCF_A::_12_MHZ) }
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
...
pub struct MOSCXTST_W<'a> { w: &'a mut W }
...
pub struct MOSCSEL_W<'a> { w: &'a mut W }
...
pub struct CFDEN_W<'a> { w: &'a mut W }
...
impl R {
    ...
    #[inline(always)]
    pub fn moscxten(&self) -> MOSCXTEN_R { MOSCXTEN_R::new((self.bits & 0x01) != 0) }
    #[doc = "Bit 1 - Main Crystal Oscillator Bypass"]
    #[inline(always)]
    pub fn moscxtby(&self) -> MOSCXTBY_R { MOSCXTBY_R::new(((self.bits >> 1) & 0x01) != 0) }
    #[doc = "Bit 3 - Main On-Chip RC Oscillator Enable"]
    #[inline(always)]
    pub fn moscrcen(&self) -> MOSCRCEN_R { MOSCRCEN_R::new(((self.bits >> 3) & 0x01) != 0) }
    #[doc = "Bits 4:6 - Main On-Chip RC Oscillator Frequency Selection"]
    #[inline(always)]
    pub fn moscrcf(&self) -> MOSCRCF_R { MOSCRCF_R::new(((self.bits >> 4) & 0x07) as u8) }
    #[doc = "Bits 8:15 - Main Crystal Oscillator Start-up Time"]
    #[inline(always)]
    pub fn moscxtst(&self) -> MOSCXTST_R { MOSCXTST_R::new(((self.bits >> 8) & 0xff) as u8) }
    #[doc = "Bits 16:23 - Password"]
    #[inline(always)]
    pub fn key(&self) -> KEY_R { KEY_R::new(((self.bits >> 16) & 0xff) as u8) }
    #[doc = "Bit 24 - Main Oscillator Selection"]
    #[inline(always)]
    pub fn moscsel(&self) -> MOSCSEL_R { MOSCSEL_R::new(((self.bits >> 24) & 0x01) != 0) }
    #[doc = "Bit 25 - Clock Failure Detector Enable"]
    #[inline(always)]
    pub fn cfden(&self) -> CFDEN_R { CFDEN_R::new(((self.bits >> 25) & 0x01) != 0) }
}

impl W {
    #[doc = "Bit 0 - Main Crystal Oscillator Enable"]
    #[inline(always)]
    pub fn moscxten(&mut self) -> MOSCXTEN_W { MOSCXTEN_W { w: self } }
    #[doc = "Bit 1 - Main Crystal Oscillator Bypass"]
    #[inline(always)]
    pub fn moscxtby(&mut self) -> MOSCXTBY_W { MOSCXTBY_W { w: self } }
    #[doc = "Bit 3 - Main On-Chip RC Oscillator Enable"]
    #[inline(always)]
    pub fn moscrcen(&mut self) -> MOSCRCEN_W { MOSCRCEN_W { w: self } }
    #[doc = "Bits 4:6 - Main On-Chip RC Oscillator Frequency Selection"]
    #[inline(always)]
    pub fn moscrcf(&mut self) -> MOSCRCF_W { MOSCRCF_W { w: self } }
    #[doc = "Bits 8:15 - Main Crystal Oscillator Start-up Time"]
    #[inline(always)]
    pub fn moscxtst(&mut self) -> MOSCXTST_W { MOSCXTST_W { w: self } }
    #[doc = "Bits 16:23 - Password"]
    #[inline(always)]
    pub fn key(&mut self) -> KEY_W { KEY_W { w: self } }
    #[doc = "Bit 24 - Main Oscillator Selection"]
    #[inline(always)]
    pub fn moscsel(&mut self) -> MOSCSEL_W { MOSCSEL_W { w: self } }
    #[doc = "Bit 25 - Clock Failure Detector Enable"]
    #[inline(always)]
    pub fn cfden(&mut self) -> CFDEN_W { CFDEN_W { w: self } }
}