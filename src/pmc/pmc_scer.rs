...
pub struct UOTGCLK_W<'a> { w: &'a mut W }
...
impl W {
    ...
    #[inline(always)]
    pub fn uotgclk(&mut self) -> UOTGCLK_W { UOTGCLK_W { w: self } }
    #[doc = "Bit 8 - Programmable Clock 0 Output Enable"]
    #[inline(always)]
    pub fn pck0(&mut self) -> PCK0_W { PCK0_W { w: self } }
    #[doc = "Bit 9 - Programmable Clock 1 Output Enable"]
    #[inline(always)]
    pub fn pck1(&mut self) -> PCK1_W { PCK1_W { w: self } }
    #[doc = "Bit 10 - Programmable Clock 2 Output Enable"]
    #[inline(always)]
    pub fn pck2(&mut self) -> PCK2_W { PCK2_W { w: self } }
}