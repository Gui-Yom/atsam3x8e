...
pub struct MOSCXTS_W<'a> { w: &'a mut W }
...
pub struct LOCKA_W<'a> { w: &'a mut W }
...
pub struct MCKRDY_W<'a> { w: &'a mut W }
...
pub struct LOCKU_W<'a> { w: &'a mut W }
...
pub struct PCKRDY0_W<'a> { w: &'a mut W }
...
pub struct PCKRDY1_W<'a> { w: &'a mut W }
...
pub struct PCKRDY2_W<'a> { w: &'a mut W }
...
pub struct MOSCSELS_W<'a> { w: &'a mut W }
...
pub struct MOSCRCS_W<'a> { w: &'a mut W }
...
pub struct CFDEV_W<'a> { w: &'a mut W }
...
impl W {
    ...
    #[inline(always)]
    pub fn moscxts(&mut self) -> MOSCXTS_W { MOSCXTS_W { w: self } }
    #[doc = "Bit 1 - PLLA Lock Interrupt Disable"]
    #[inline(always)]
    pub fn locka(&mut self) -> LOCKA_W { LOCKA_W { w: self } }
    #[doc = "Bit 3 - Master Clock Ready Interrupt Disable"]
    #[inline(always)]
    pub fn mckrdy(&mut self) -> MCKRDY_W { MCKRDY_W { w: self } }
    #[doc = "Bit 6 - UTMI PLL Lock Interrupt Disable"]
    #[inline(always)]
    pub fn locku(&mut self) -> LOCKU_W { LOCKU_W { w: self } }
    #[doc = "Bit 8 - Programmable Clock Ready 0 Interrupt Disable"]
    #[inline(always)]
    pub fn pckrdy0(&mut self) -> PCKRDY0_W { PCKRDY0_W { w: self } }
    #[doc = "Bit 9 - Programmable Clock Ready 1 Interrupt Disable"]
    #[inline(always)]
    pub fn pckrdy1(&mut self) -> PCKRDY1_W { PCKRDY1_W { w: self } }
    #[doc = "Bit 10 - Programmable Clock Ready 2 Interrupt Disable"]
    #[inline(always)]
    pub fn pckrdy2(&mut self) -> PCKRDY2_W { PCKRDY2_W { w: self } }
    #[doc = "Bit 16 - Main Oscillator Selection Status Interrupt Disable"]
    #[inline(always)]
    pub fn moscsels(&mut self) -> MOSCSELS_W { MOSCSELS_W { w: self } }
    #[doc = "Bit 17 - Main On-Chip RC Status Interrupt Disable"]
    #[inline(always)]
    pub fn moscrcs(&mut self) -> MOSCRCS_W { MOSCRCS_W { w: self } }
    #[doc = "Bit 18 - Clock Failure Detector Event Interrupt Disable"]
    #[inline(always)]
    pub fn cfdev(&mut self) -> CFDEV_W { CFDEV_W { w: self } }
}