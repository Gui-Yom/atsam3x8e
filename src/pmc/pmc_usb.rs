...
pub struct USBDIV_W<'a> { w: &'a mut W }
...
impl R {
    ...
    #[inline(always)]
    pub fn usbs(&self) -> USBS_R { USBS_R::new((self.bits & 0x01) != 0) }
    #[doc = "Bits 8:11 - Divider for USB Clock."]
    #[inline(always)]
    pub fn usbdiv(&self) -> USBDIV_R { USBDIV_R::new(((self.bits >> 8) & 0x0f) as u8) }
}

impl W {
    #[doc = "Bit 0 - USB Input Clock Selection"]
    #[inline(always)]
    pub fn usbs(&mut self) -> USBS_W { USBS_W { w: self } }
    #[doc = "Bits 8:11 - Divider for USB Clock."]
    #[inline(always)]
    pub fn usbdiv(&mut self) -> USBDIV_W { USBDIV_W { w: self } }
}