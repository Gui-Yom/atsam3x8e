...
pub struct FSTP0_W<'a> { w: &'a mut W }
...
pub struct FSTP1_W<'a> { w: &'a mut W }
...
pub struct FSTP2_W<'a> { w: &'a mut W }
...
pub struct FSTP3_W<'a> { w: &'a mut W }
...
pub struct FSTP4_W<'a> { w: &'a mut W }
...
pub struct FSTP5_W<'a> { w: &'a mut W }
...
pub struct FSTP6_W<'a> { w: &'a mut W }
...
pub struct FSTP7_W<'a> { w: &'a mut W }
...
pub struct FSTP8_W<'a> { w: &'a mut W }
...
pub struct FSTP9_W<'a> { w: &'a mut W }
...
pub struct FSTP10_W<'a> { w: &'a mut W }
...
pub struct FSTP11_W<'a> { w: &'a mut W }
...
pub struct FSTP12_W<'a> { w: &'a mut W }
...
pub struct FSTP13_W<'a> { w: &'a mut W }
...
pub struct FSTP14_W<'a> { w: &'a mut W }
...
pub struct FSTP15_W<'a> { w: &'a mut W }
...
impl R {
    ...
    #[inline(always)]
    pub fn fstp0(&self) -> FSTP0_R { FSTP0_R::new((self.bits & 0x01) != 0) }
    #[doc = "Bit 1 - Fast Startup Input Polarityx"]
    #[inline(always)]
    pub fn fstp1(&self) -> FSTP1_R { FSTP1_R::new(((self.bits >> 1) & 0x01) != 0) }
    #[doc = "Bit 2 - Fast Startup Input Polarityx"]
    #[inline(always)]
    pub fn fstp2(&self) -> FSTP2_R { FSTP2_R::new(((self.bits >> 2) & 0x01) != 0) }
    #[doc = "Bit 3 - Fast Startup Input Polarityx"]
    #[inline(always)]
    pub fn fstp3(&self) -> FSTP3_R { FSTP3_R::new(((self.bits >> 3) & 0x01) != 0) }
    #[doc = "Bit 4 - Fast Startup Input Polarityx"]
    #[inline(always)]
    pub fn fstp4(&self) -> FSTP4_R { FSTP4_R::new(((self.bits >> 4) & 0x01) != 0) }
    #[doc = "Bit 5 - Fast Startup Input Polarityx"]
    #[inline(always)]
    pub fn fstp5(&self) -> FSTP5_R { FSTP5_R::new(((self.bits >> 5) & 0x01) != 0) }
    #[doc = "Bit 6 - Fast Startup Input Polarityx"]
    #[inline(always)]
    pub fn fstp6(&self) -> FSTP6_R { FSTP6_R::new(((self.bits >> 6) & 0x01) != 0) }
    #[doc = "Bit 7 - Fast Startup Input Polarityx"]
    #[inline(always)]
    pub fn fstp7(&self) -> FSTP7_R { FSTP7_R::new(((self.bits >> 7) & 0x01) != 0) }
    #[doc = "Bit 8 - Fast Startup Input Polarityx"]
    #[inline(always)]
    pub fn fstp8(&self) -> FSTP8_R { FSTP8_R::new(((self.bits >> 8) & 0x01) != 0) }
    #[doc = "Bit 9 - Fast Startup Input Polarityx"]
    #[inline(always)]
    pub fn fstp9(&self) -> FSTP9_R { FSTP9_R::new(((self.bits >> 9) & 0x01) != 0) }
    #[doc = "Bit 10 - Fast Startup Input Polarityx"]
    #[inline(always)]
    pub fn fstp10(&self) -> FSTP10_R { FSTP10_R::new(((self.bits >> 10) & 0x01) != 0) }
    #[doc = "Bit 11 - Fast Startup Input Polarityx"]
    #[inline(always)]
    pub fn fstp11(&self) -> FSTP11_R { FSTP11_R::new(((self.bits >> 11) & 0x01) != 0) }
    #[doc = "Bit 12 - Fast Startup Input Polarityx"]
    #[inline(always)]
    pub fn fstp12(&self) -> FSTP12_R { FSTP12_R::new(((self.bits >> 12) & 0x01) != 0) }
    #[doc = "Bit 13 - Fast Startup Input Polarityx"]
    #[inline(always)]
    pub fn fstp13(&self) -> FSTP13_R { FSTP13_R::new(((self.bits >> 13) & 0x01) != 0) }
    #[doc = "Bit 14 - Fast Startup Input Polarityx"]
    #[inline(always)]
    pub fn fstp14(&self) -> FSTP14_R { FSTP14_R::new(((self.bits >> 14) & 0x01) != 0) }
    #[doc = "Bit 15 - Fast Startup Input Polarityx"]
    #[inline(always)]
    pub fn fstp15(&self) -> FSTP15_R { FSTP15_R::new(((self.bits >> 15) & 0x01) != 0) }
}

impl W {
    #[doc = "Bit 0 - Fast Startup Input Polarityx"]
    #[inline(always)]
    pub fn fstp0(&mut self) -> FSTP0_W { FSTP0_W { w: self } }
    #[doc = "Bit 1 - Fast Startup Input Polarityx"]
    #[inline(always)]
    pub fn fstp1(&mut self) -> FSTP1_W { FSTP1_W { w: self } }
    #[doc = "Bit 2 - Fast Startup Input Polarityx"]
    #[inline(always)]
    pub fn fstp2(&mut self) -> FSTP2_W { FSTP2_W { w: self } }
    #[doc = "Bit 3 - Fast Startup Input Polarityx"]
    #[inline(always)]
    pub fn fstp3(&mut self) -> FSTP3_W { FSTP3_W { w: self } }
    #[doc = "Bit 4 - Fast Startup Input Polarityx"]
    #[inline(always)]
    pub fn fstp4(&mut self) -> FSTP4_W { FSTP4_W { w: self } }
    #[doc = "Bit 5 - Fast Startup Input Polarityx"]
    #[inline(always)]
    pub fn fstp5(&mut self) -> FSTP5_W { FSTP5_W { w: self } }
    #[doc = "Bit 6 - Fast Startup Input Polarityx"]
    #[inline(always)]
    pub fn fstp6(&mut self) -> FSTP6_W { FSTP6_W { w: self } }
    #[doc = "Bit 7 - Fast Startup Input Polarityx"]
    #[inline(always)]
    pub fn fstp7(&mut self) -> FSTP7_W { FSTP7_W { w: self } }
    #[doc = "Bit 8 - Fast Startup Input Polarityx"]
    #[inline(always)]
    pub fn fstp8(&mut self) -> FSTP8_W { FSTP8_W { w: self } }
    #[doc = "Bit 9 - Fast Startup Input Polarityx"]
    #[inline(always)]
    pub fn fstp9(&mut self) -> FSTP9_W { FSTP9_W { w: self } }
    #[doc = "Bit 10 - Fast Startup Input Polarityx"]
    #[inline(always)]
    pub fn fstp10(&mut self) -> FSTP10_W { FSTP10_W { w: self } }
    #[doc = "Bit 11 - Fast Startup Input Polarityx"]
    #[inline(always)]
    pub fn fstp11(&mut self) -> FSTP11_W { FSTP11_W { w: self } }
    #[doc = "Bit 12 - Fast Startup Input Polarityx"]
    #[inline(always)]
    pub fn fstp12(&mut self) -> FSTP12_W { FSTP12_W { w: self } }
    #[doc = "Bit 13 - Fast Startup Input Polarityx"]
    #[inline(always)]
    pub fn fstp13(&mut self) -> FSTP13_W { FSTP13_W { w: self } }
    #[doc = "Bit 14 - Fast Startup Input Polarityx"]
    #[inline(always)]
    pub fn fstp14(&mut self) -> FSTP14_W { FSTP14_W { w: self } }
    #[doc = "Bit 15 - Fast Startup Input Polarityx"]
    #[inline(always)]
    pub fn fstp15(&mut self) -> FSTP15_W { FSTP15_W { w: self } }
}