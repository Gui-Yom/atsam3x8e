...
pub struct WP_EN_W<'a> { w: &'a mut W }
...
pub struct WP_KEY_W<'a> { w: &'a mut W }
...
impl R {
    ...
    #[inline(always)]
    pub fn wp_en(&self) -> WP_EN_R { WP_EN_R::new((self.bits & 0x01) != 0) }
    #[doc = "Bits 8:31 - Write Protection Key password"]
    #[inline(always)]
    pub fn wp_key(&self) -> WP_KEY_R { WP_KEY_R::new(((self.bits >> 8) & 0x00ff_ffff) as u32) }
}

impl W {
    #[doc = "Bit 0 - Write Protection Enable"]
    #[inline(always)]
    pub fn wp_en(&mut self) -> WP_EN_W { WP_EN_W { w: self } }
    #[doc = "Bits 8:31 - Write Protection Key password"]
    #[inline(always)]
    pub fn wp_key(&mut self) -> WP_KEY_W { WP_KEY_W { w: self } }
}