...
pub struct FIFOMODE_W<'a> { w: &'a mut W }
...
pub struct FERRCTRL_W<'a> { w: &'a mut W }
...
pub struct HSMODE_W<'a> { w: &'a mut W }
...
pub struct LSYNC_W<'a> { w: &'a mut W }
...
impl R {
    ...
    #[inline(always)]
    pub fn fifomode(&self) -> FIFOMODE_R { FIFOMODE_R::new((self.bits & 0x01) != 0) }
    #[doc = "Bit 4 - Flow Error flag reset control mode"]
    #[inline(always)]
    pub fn ferrctrl(&self) -> FERRCTRL_R { FERRCTRL_R::new(((self.bits >> 4) & 0x01) != 0) }
    #[doc = "Bit 8 - High Speed Mode"]
    #[inline(always)]
    pub fn hsmode(&self) -> HSMODE_R { HSMODE_R::new(((self.bits >> 8) & 0x01) != 0) }
    #[doc = "Bit 12 - Synchronize on the last block"]
    #[inline(always)]
    pub fn lsync(&self) -> LSYNC_R { LSYNC_R::new(((self.bits >> 12) & 0x01) != 0) }
}

impl W {
    #[doc = "Bit 0 - HSMCI Internal FIFO control mode"]
    #[inline(always)]
    pub fn fifomode(&mut self) -> FIFOMODE_W { FIFOMODE_W { w: self } }
    #[doc = "Bit 4 - Flow Error flag reset control mode"]
    #[inline(always)]
    pub fn ferrctrl(&mut self) -> FERRCTRL_W { FERRCTRL_W { w: self } }
    #[doc = "Bit 8 - High Speed Mode"]
    #[inline(always)]
    pub fn hsmode(&mut self) -> HSMODE_W { HSMODE_W { w: self } }
    #[doc = "Bit 12 - Synchronize on the last block"]
    #[inline(always)]
    pub fn lsync(&mut self) -> LSYNC_W { LSYNC_W { w: self } }
}