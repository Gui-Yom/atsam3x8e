...
pub struct CLKDIV_W<'a> { w: &'a mut W }
...
pub struct PWSDIV_W<'a> { w: &'a mut W }
...
pub struct RDPROOF_W<'a> { w: &'a mut W }
...
pub struct WRPROOF_W<'a> { w: &'a mut W }
...
pub struct FBYTE_W<'a> { w: &'a mut W }
...
impl R {
    ...
    #[inline(always)]
    pub fn clkdiv(&self) -> CLKDIV_R { CLKDIV_R::new((self.bits & 0xff) as u8) }
    #[doc = "Bits 8:10 - Power Saving Divider"]
    #[inline(always)]
    pub fn pwsdiv(&self) -> PWSDIV_R { PWSDIV_R::new(((self.bits >> 8) & 0x07) as u8) }
    #[doc = "Bit 11"]
    #[inline(always)]
    pub fn rdproof(&self) -> RDPROOF_R { RDPROOF_R::new(((self.bits >> 11) & 0x01) != 0) }
    #[doc = "Bit 12"]
    #[inline(always)]
    pub fn wrproof(&self) -> WRPROOF_R { WRPROOF_R::new(((self.bits >> 12) & 0x01) != 0) }
    #[doc = "Bit 13 - Force Byte Transfer"]
    #[inline(always)]
    pub fn fbyte(&self) -> FBYTE_R { FBYTE_R::new(((self.bits >> 13) & 0x01) != 0) }
    #[doc = "Bit 14 - Padding Value"]
    #[inline(always)]
    pub fn padv(&self) -> PADV_R { PADV_R::new(((self.bits >> 14) & 0x01) != 0) }
}

impl W {
    #[doc = "Bits 0:7 - Clock Divider"]
    #[inline(always)]
    pub fn clkdiv(&mut self) -> CLKDIV_W { CLKDIV_W { w: self } }
    #[doc = "Bits 8:10 - Power Saving Divider"]
    #[inline(always)]
    pub fn pwsdiv(&mut self) -> PWSDIV_W { PWSDIV_W { w: self } }
    #[doc = "Bit 11"]
    #[inline(always)]
    pub fn rdproof(&mut self) -> RDPROOF_W { RDPROOF_W { w: self } }
    #[doc = "Bit 12"]
    #[inline(always)]
    pub fn wrproof(&mut self) -> WRPROOF_W { WRPROOF_W { w: self } }
    #[doc = "Bit 13 - Force Byte Transfer"]
    #[inline(always)]
    pub fn fbyte(&mut self) -> FBYTE_W { FBYTE_W { w: self } }
    #[doc = "Bit 14 - Padding Value"]
    #[inline(always)]
    pub fn padv(&mut self) -> PADV_W { PADV_W { w: self } }
}