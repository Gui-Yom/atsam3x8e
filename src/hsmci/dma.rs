...
pub struct OFFSET_W<'a> { w: &'a mut W }
...
pub enum CHKSIZE_A { #[doc = "0: 1 data available"] _1 = 0, #[doc = "1: 4 data available"] _4 = 1 }

impl From<CHKSIZE_A> for bool {
    #[inline(always)]
    fn from(variant: CHKSIZE_A) -> Self { variant as u8 != 0 }
}
...
impl CHKSIZE_R {
    ...
    #[inline(always)]
    pub fn is_1(&self) -> bool { *self == CHKSIZE_A::_1 }
    #[doc = "Checks if the value of the field is `_4`"]
    #[inline(always)]
    pub fn is_4(&self) -> bool { *self == CHKSIZE_A::_4 }
}

#[doc = "Write proxy for field `CHKSIZE`"]
pub struct CHKSIZE_W<'a> { w: &'a mut W }

impl<'a> CHKSIZE_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: CHKSIZE_A) -> &'a mut W { self.bit(variant.into()) }
    #[doc = "1 data available"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W { self.variant(CHKSIZE_A::_1) }
    #[doc = "4 data available"]
    #[inline(always)]
    pub fn _4(self) -> &'a mut W { self.variant(CHKSIZE_A::_4) }
...
pub struct DMAEN_W<'a> { w: &'a mut W }
...
impl R {
    ...
    #[inline(always)]
    pub fn offset(&self) -> OFFSET_R { OFFSET_R::new((self.bits & 0x03) as u8) }
    #[doc = "Bit 4 - DMA Channel Read and Write Chunk Size"]
    #[inline(always)]
    pub fn chksize(&self) -> CHKSIZE_R { CHKSIZE_R::new(((self.bits >> 4) & 0x01) != 0) }
    #[doc = "Bit 8 - DMA Hardware Handshaking Enable"]
    #[inline(always)]
    pub fn dmaen(&self) -> DMAEN_R { DMAEN_R::new(((self.bits >> 8) & 0x01) != 0) }
    #[doc = "Bit 12 - Read Optimization with padding"]
    #[inline(always)]
    pub fn ropt(&self) -> ROPT_R { ROPT_R::new(((self.bits >> 12) & 0x01) != 0) }
}

impl W {
    #[doc = "Bits 0:1 - DMA Write Buffer Offset"]
    #[inline(always)]
    pub fn offset(&mut self) -> OFFSET_W { OFFSET_W { w: self } }
    #[doc = "Bit 4 - DMA Channel Read and Write Chunk Size"]
    #[inline(always)]
    pub fn chksize(&mut self) -> CHKSIZE_W { CHKSIZE_W { w: self } }
    #[doc = "Bit 8 - DMA Hardware Handshaking Enable"]
    #[inline(always)]
    pub fn dmaen(&mut self) -> DMAEN_W { DMAEN_W { w: self } }
    #[doc = "Bit 12 - Read Optimization with padding"]
    #[inline(always)]
    pub fn ropt(&mut self) -> ROPT_W { ROPT_W { w: self } }
}