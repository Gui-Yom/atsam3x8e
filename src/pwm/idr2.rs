...
pub struct ENDTX_W<'a> { w: &'a mut W }
...
pub struct TXBUFE_W<'a> { w: &'a mut W }
...
pub struct CMPM0_W<'a> { w: &'a mut W }
...
pub struct CMPM1_W<'a> { w: &'a mut W }
...
pub struct CMPM2_W<'a> { w: &'a mut W }
...
pub struct CMPM3_W<'a> { w: &'a mut W }
...
pub struct CMPM4_W<'a> { w: &'a mut W }
...
pub struct CMPM5_W<'a> { w: &'a mut W }
...
pub struct CMPM6_W<'a> { w: &'a mut W }
...
pub struct CMPM7_W<'a> { w: &'a mut W }
...
pub struct CMPU0_W<'a> { w: &'a mut W }
...
pub struct CMPU1_W<'a> { w: &'a mut W }
...
pub struct CMPU2_W<'a> { w: &'a mut W }
...
pub struct CMPU3_W<'a> { w: &'a mut W }
...
pub struct CMPU4_W<'a> { w: &'a mut W }
...
pub struct CMPU5_W<'a> { w: &'a mut W }
...
pub struct CMPU6_W<'a> { w: &'a mut W }
...
pub struct CMPU7_W<'a> { w: &'a mut W }
...
impl W {
    ...
    #[inline(always)]
    pub fn wrdy(&mut self) -> WRDY_W { WRDY_W { w: self } }
    #[doc = "Bit 1 - PDC End of TX Buffer Interrupt Disable"]
    #[inline(always)]
    pub fn endtx(&mut self) -> ENDTX_W { ENDTX_W { w: self } }
    #[doc = "Bit 2 - PDC TX Buffer Empty Interrupt Disable"]
    #[inline(always)]
    pub fn txbufe(&mut self) -> TXBUFE_W { TXBUFE_W { w: self } }
