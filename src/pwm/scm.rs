...
pub struct SYNC0_W<'a> { w: &'a mut W }
...
pub struct SYNC1_W<'a> { w: &'a mut W }
...
pub struct SYNC2_W<'a> { w: &'a mut W }
...
pub struct SYNC3_W<'a> { w: &'a mut W }
...
pub struct SYNC4_W<'a> { w: &'a mut W }
...
pub struct SYNC5_W<'a> { w: &'a mut W }
...
pub struct SYNC6_W<'a> { w: &'a mut W }
...
pub struct SYNC7_W<'a> { w: &'a mut W }
...
#[repr(u8)]
pub enum UPDM_A { #[doc = "0: Manual write of double buffer registers and manual update of synchronous channels"] MODE0 = 0, #[doc = "1: Manual write of double buffer registers and automatic update of synchronous channels"] MODE1 = 1, #[doc = "2: Automatic write of duty-cycle update registers by the PDC and automatic update of synchronous channels"] MODE2 = 2 }

impl From<UPDM_A> for u8 {
    #[inline(always)]
    fn from(variant: UPDM_A) -> Self { variant as _ }
}
...
impl UPDM_R {
    ...
    #[inline(always)]
    pub fn is_mode0(&self) -> bool { *self == UPDM_A::MODE0 }
    #[doc = "Checks if the value of the field is `MODE1`"]
    #[inline(always)]
    pub fn is_mode1(&self) -> bool { *self == UPDM_A::MODE1 }
    #[doc = "Checks if the value of the field is `MODE2`"]
    #[inline(always)]
    pub fn is_mode2(&self) -> bool { *self == UPDM_A::MODE2 }
}

#[doc = "Write proxy for field `UPDM`"]
pub struct UPDM_W<'a> { w: &'a mut W }

impl<'a> UPDM_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: UPDM_A) -> &'a mut W { unsafe { self.bits(variant.into()) } }
    #[doc = "Manual write of double buffer registers and manual update of synchronous channels"]
    #[inline(always)]
    pub fn mode0(self) -> &'a mut W { self.variant(UPDM_A::MODE0) }
    #[doc = "Manual write of double buffer registers and automatic update of synchronous channels"]
    #[inline(always)]
    pub fn mode1(self) -> &'a mut W { self.variant(UPDM_A::MODE1) }
    #[doc = "Automatic write of duty-cycle update registers by the PDC and automatic update of synchronous channels"]
    #[inline(always)]
    pub fn mode2(self) -> &'a mut W { self.variant(UPDM_A::MODE2) }
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
...
pub struct PTRCS_W<'a> { w: &'a mut W }
...
impl R {
    ...
    #[inline(always)]
    pub fn sync0(&self) -> SYNC0_R { SYNC0_R::new((self.bits & 0x01) != 0) }
    #[doc = "Bit 1 - Synchronous Channel 1"]
    #[inline(always)]
    pub fn sync1(&self) -> SYNC1_R { SYNC1_R::new(((self.bits >> 1) & 0x01) != 0) }
    #[doc = "Bit 2 - Synchronous Channel 2"]
    #[inline(always)]
    pub fn sync2(&self) -> SYNC2_R { SYNC2_R::new(((self.bits >> 2) & 0x01) != 0) }
    #[doc = "Bit 3 - Synchronous Channel 3"]
    #[inline(always)]
    pub fn sync3(&self) -> SYNC3_R { SYNC3_R::new(((self.bits >> 3) & 0x01) != 0) }
    #[doc = "Bit 4 - Synchronous Channel 4"]
    #[inline(always)]
    pub fn sync4(&self) -> SYNC4_R { SYNC4_R::new(((self.bits >> 4) & 0x01) != 0) }
    #[doc = "Bit 5 - Synchronous Channel 5"]
    #[inline(always)]
    pub fn sync5(&self) -> SYNC5_R { SYNC5_R::new(((self.bits >> 5) & 0x01) != 0) }
    #[doc = "Bit 6 - Synchronous Channel 6"]
    #[inline(always)]
    pub fn sync6(&self) -> SYNC6_R { SYNC6_R::new(((self.bits >> 6) & 0x01) != 0) }
    #[doc = "Bit 7 - Synchronous Channel 7"]
    #[inline(always)]
    pub fn sync7(&self) -> SYNC7_R { SYNC7_R::new(((self.bits >> 7) & 0x01) != 0) }
    #[doc = "Bits 16:17 - Synchronous Channels Update Mode"]
    #[inline(always)]
    pub fn updm(&self) -> UPDM_R { UPDM_R::new(((self.bits >> 16) & 0x03) as u8) }
    #[doc = "Bit 20 - PDC Transfer Request Mode"]
    #[inline(always)]
    pub fn ptrm(&self) -> PTRM_R { PTRM_R::new(((self.bits >> 20) & 0x01) != 0) }
    #[doc = "Bits 21:23 - PDC Transfer Request Comparison Selection"]
    #[inline(always)]
    pub fn ptrcs(&self) -> PTRCS_R { PTRCS_R::new(((self.bits >> 21) & 0x07) as u8) }
}

impl W {
    #[doc = "Bit 0 - Synchronous Channel 0"]
    #[inline(always)]
    pub fn sync0(&mut self) -> SYNC0_W { SYNC0_W { w: self } }
    #[doc = "Bit 1 - Synchronous Channel 1"]
    #[inline(always)]
    pub fn sync1(&mut self) -> SYNC1_W { SYNC1_W { w: self } }
    #[doc = "Bit 2 - Synchronous Channel 2"]
    #[inline(always)]
    pub fn sync2(&mut self) -> SYNC2_W { SYNC2_W { w: self } }
    #[doc = "Bit 3 - Synchronous Channel 3"]
    #[inline(always)]
    pub fn sync3(&mut self) -> SYNC3_W { SYNC3_W { w: self } }
    #[doc = "Bit 4 - Synchronous Channel 4"]
    #[inline(always)]
    pub fn sync4(&mut self) -> SYNC4_W { SYNC4_W { w: self } }
    #[doc = "Bit 5 - Synchronous Channel 5"]
    #[inline(always)]
    pub fn sync5(&mut self) -> SYNC5_W { SYNC5_W { w: self } }
    #[doc = "Bit 6 - Synchronous Channel 6"]
    #[inline(always)]
    pub fn sync6(&mut self) -> SYNC6_W { SYNC6_W { w: self } }
    #[doc = "Bit 7 - Synchronous Channel 7"]
    #[inline(always)]
    pub fn sync7(&mut self) -> SYNC7_W { SYNC7_W { w: self } }
    #[doc = "Bits 16:17 - Synchronous Channels Update Mode"]
    #[inline(always)]
    pub fn updm(&mut self) -> UPDM_W { UPDM_W { w: self } }
    #[doc = "Bit 20 - PDC Transfer Request Mode"]
    #[inline(always)]
    pub fn ptrm(&mut self) -> PTRM_W { PTRM_W { w: self } }
    #[doc = "Bits 21:23 - PDC Transfer Request Comparison Selection"]
    #[inline(always)]
    pub fn ptrcs(&mut self) -> PTRCS_W { PTRCS_W { w: self } }
}