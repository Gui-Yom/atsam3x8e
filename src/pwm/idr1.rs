...
pub struct CHID0_W<'a> { w: &'a mut W }
...
pub struct CHID1_W<'a> { w: &'a mut W }
...
pub struct CHID2_W<'a> { w: &'a mut W }
...
pub struct CHID3_W<'a> { w: &'a mut W }
...
pub struct CHID4_W<'a> { w: &'a mut W }
...
pub struct CHID5_W<'a> { w: &'a mut W }
...
pub struct CHID6_W<'a> { w: &'a mut W }
...
pub struct CHID7_W<'a> { w: &'a mut W }
...
pub struct FCHID0_W<'a> { w: &'a mut W }
...
pub struct FCHID1_W<'a> { w: &'a mut W }
...
pub struct FCHID2_W<'a> { w: &'a mut W }
...
pub struct FCHID3_W<'a> { w: &'a mut W }
...
pub struct FCHID4_W<'a> { w: &'a mut W }
...
pub struct FCHID5_W<'a> { w: &'a mut W }
...
pub struct FCHID6_W<'a> { w: &'a mut W }
...
pub struct FCHID7_W<'a> { w: &'a mut W }
