...
pub struct OOVH0_W<'a> { w: &'a mut W }
...
pub struct OOVH1_W<'a> { w: &'a mut W }
...
pub struct OOVH2_W<'a> { w: &'a mut W }
...
pub struct OOVH3_W<'a> { w: &'a mut W }
...
pub struct OOVH4_W<'a> { w: &'a mut W }
...
pub struct OOVH5_W<'a> { w: &'a mut W }
...
pub struct OOVH6_W<'a> { w: &'a mut W }
...
pub struct OOVH7_W<'a> { w: &'a mut W }
...
pub struct OOVL0_W<'a> { w: &'a mut W }
...
pub struct OOVL1_W<'a> { w: &'a mut W }
...
pub struct OOVL2_W<'a> { w: &'a mut W }
...
pub struct OOVL3_W<'a> { w: &'a mut W }
...
pub struct OOVL4_W<'a> { w: &'a mut W }
...
pub struct OOVL5_W<'a> { w: &'a mut W }
...
pub struct OOVL6_W<'a> { w: &'a mut W }
...
pub struct OOVL7_W<'a> { w: &'a mut W }
...
impl R {
    ...
    #[inline(always)]
    pub fn oovh0(&self) -> OOVH0_R { OOVH0_R::new((self.bits & 0x01) != 0) }
    #[doc = "Bit 1 - Output Override Value for PWMH output of the channel 1"]
    #[inline(always)]
    pub fn oovh1(&self) -> OOVH1_R { OOVH1_R::new(((self.bits >> 1) & 0x01) != 0) }
    #[doc = "Bit 2 - Output Override Value for PWMH output of the channel 2"]
    #[inline(always)]
    pub fn oovh2(&self) -> OOVH2_R { OOVH2_R::new(((self.bits >> 2) & 0x01) != 0) }
    #[doc = "Bit 3 - Output Override Value for PWMH output of the channel 3"]
    #[inline(always)]
    pub fn oovh3(&self) -> OOVH3_R { OOVH3_R::new(((self.bits >> 3) & 0x01) != 0) }
    #[doc = "Bit 4 - Output Override Value for PWMH output of the channel 4"]
    #[inline(always)]
    pub fn oovh4(&self) -> OOVH4_R { OOVH4_R::new(((self.bits >> 4) & 0x01) != 0) }
    #[doc = "Bit 5 - Output Override Value for PWMH output of the channel 5"]
    #[inline(always)]
    pub fn oovh5(&self) -> OOVH5_R { OOVH5_R::new(((self.bits >> 5) & 0x01) != 0) }
    #[doc = "Bit 6 - Output Override Value for PWMH output of the channel 6"]
    #[inline(always)]
    pub fn oovh6(&self) -> OOVH6_R { OOVH6_R::new(((self.bits >> 6) & 0x01) != 0) }
    #[doc = "Bit 7 - Output Override Value for PWMH output of the channel 7"]
    #[inline(always)]
    pub fn oovh7(&self) -> OOVH7_R { OOVH7_R::new(((self.bits >> 7) & 0x01) != 0) }
    #[doc = "Bit 16 - Output Override Value for PWML output of the channel 0"]
    #[inline(always)]
    pub fn oovl0(&self) -> OOVL0_R { OOVL0_R::new(((self.bits >> 16) & 0x01) != 0) }
    #[doc = "Bit 17 - Output Override Value for PWML output of the channel 1"]
    #[inline(always)]
    pub fn oovl1(&self) -> OOVL1_R { OOVL1_R::new(((self.bits >> 17) & 0x01) != 0) }
    #[doc = "Bit 18 - Output Override Value for PWML output of the channel 2"]
    #[inline(always)]
    pub fn oovl2(&self) -> OOVL2_R { OOVL2_R::new(((self.bits >> 18) & 0x01) != 0) }
    #[doc = "Bit 19 - Output Override Value for PWML output of the channel 3"]
    #[inline(always)]
    pub fn oovl3(&self) -> OOVL3_R { OOVL3_R::new(((self.bits >> 19) & 0x01) != 0) }
    #[doc = "Bit 20 - Output Override Value for PWML output of the channel 4"]
    #[inline(always)]
    pub fn oovl4(&self) -> OOVL4_R { OOVL4_R::new(((self.bits >> 20) & 0x01) != 0) }
    #[doc = "Bit 21 - Output Override Value for PWML output of the channel 5"]
    #[inline(always)]
    pub fn oovl5(&self) -> OOVL5_R { OOVL5_R::new(((self.bits >> 21) & 0x01) != 0) }
    #[doc = "Bit 22 - Output Override Value for PWML output of the channel 6"]
    #[inline(always)]
    pub fn oovl6(&self) -> OOVL6_R { OOVL6_R::new(((self.bits >> 22) & 0x01) != 0) }
    #[doc = "Bit 23 - Output Override Value for PWML output of the channel 7"]
    #[inline(always)]
    pub fn oovl7(&self) -> OOVL7_R { OOVL7_R::new(((self.bits >> 23) & 0x01) != 0) }
}

impl W {
    #[doc = "Bit 0 - Output Override Value for PWMH output of the channel 0"]
    #[inline(always)]
    pub fn oovh0(&mut self) -> OOVH0_W { OOVH0_W { w: self } }
    #[doc = "Bit 1 - Output Override Value for PWMH output of the channel 1"]
    #[inline(always)]
    pub fn oovh1(&mut self) -> OOVH1_W { OOVH1_W { w: self } }
    #[doc = "Bit 2 - Output Override Value for PWMH output of the channel 2"]
    #[inline(always)]
    pub fn oovh2(&mut self) -> OOVH2_W { OOVH2_W { w: self } }
    #[doc = "Bit 3 - Output Override Value for PWMH output of the channel 3"]
    #[inline(always)]
    pub fn oovh3(&mut self) -> OOVH3_W { OOVH3_W { w: self } }
    #[doc = "Bit 4 - Output Override Value for PWMH output of the channel 4"]
    #[inline(always)]
    pub fn oovh4(&mut self) -> OOVH4_W { OOVH4_W { w: self } }
    #[doc = "Bit 5 - Output Override Value for PWMH output of the channel 5"]
    #[inline(always)]
    pub fn oovh5(&mut self) -> OOVH5_W { OOVH5_W { w: self } }
    #[doc = "Bit 6 - Output Override Value for PWMH output of the channel 6"]
    #[inline(always)]
    pub fn oovh6(&mut self) -> OOVH6_W { OOVH6_W { w: self } }
    #[doc = "Bit 7 - Output Override Value for PWMH output of the channel 7"]
    #[inline(always)]
    pub fn oovh7(&mut self) -> OOVH7_W { OOVH7_W { w: self } }
    #[doc = "Bit 16 - Output Override Value for PWML output of the channel 0"]
    #[inline(always)]
    pub fn oovl0(&mut self) -> OOVL0_W { OOVL0_W { w: self } }
    #[doc = "Bit 17 - Output Override Value for PWML output of the channel 1"]
    #[inline(always)]
    pub fn oovl1(&mut self) -> OOVL1_W { OOVL1_W { w: self } }
    #[doc = "Bit 18 - Output Override Value for PWML output of the channel 2"]
    #[inline(always)]
    pub fn oovl2(&mut self) -> OOVL2_W { OOVL2_W { w: self } }
    #[doc = "Bit 19 - Output Override Value for PWML output of the channel 3"]
    #[inline(always)]
    pub fn oovl3(&mut self) -> OOVL3_W { OOVL3_W { w: self } }
    #[doc = "Bit 20 - Output Override Value for PWML output of the channel 4"]
    #[inline(always)]
    pub fn oovl4(&mut self) -> OOVL4_W { OOVL4_W { w: self } }
    #[doc = "Bit 21 - Output Override Value for PWML output of the channel 5"]
    #[inline(always)]
    pub fn oovl5(&mut self) -> OOVL5_W { OOVL5_W { w: self } }
    #[doc = "Bit 22 - Output Override Value for PWML output of the channel 6"]
    #[inline(always)]
    pub fn oovl6(&mut self) -> OOVL6_W { OOVL6_W { w: self } }
    #[doc = "Bit 23 - Output Override Value for PWML output of the channel 7"]
    #[inline(always)]
    pub fn oovl7(&mut self) -> OOVL7_W { OOVL7_W { w: self } }
}