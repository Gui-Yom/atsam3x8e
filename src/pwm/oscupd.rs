...
pub struct OSCUPH0_W<'a> { w: &'a mut W }
...
pub struct OSCUPH1_W<'a> { w: &'a mut W }
...
pub struct OSCUPH2_W<'a> { w: &'a mut W }
...
pub struct OSCUPH3_W<'a> { w: &'a mut W }
...
pub struct OSCUPH4_W<'a> { w: &'a mut W }
...
pub struct OSCUPH5_W<'a> { w: &'a mut W }
...
pub struct OSCUPH6_W<'a> { w: &'a mut W }
...
pub struct OSCUPH7_W<'a> { w: &'a mut W }
...
pub struct OSCUPL0_W<'a> { w: &'a mut W }
...
pub struct OSCUPL1_W<'a> { w: &'a mut W }
...
pub struct OSCUPL2_W<'a> { w: &'a mut W }
...
pub struct OSCUPL3_W<'a> { w: &'a mut W }
...
pub struct OSCUPL4_W<'a> { w: &'a mut W }
...
pub struct OSCUPL5_W<'a> { w: &'a mut W }
...
#[doc = "Write proxy for field `OSCUPDL6`"]
pub struct OSCUPDL6_W<'a> { w: &'a mut W }
...
pub struct OSCUPL7_W<'a> { w: &'a mut W }
