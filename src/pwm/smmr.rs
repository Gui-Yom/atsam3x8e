...
pub struct GCEN0_W<'a> { w: &'a mut W }
...
pub struct GCEN1_W<'a> { w: &'a mut W }
...
pub struct GCEN2_W<'a> { w: &'a mut W }
...
pub struct GCEN3_W<'a> { w: &'a mut W }
...
pub struct DOWN0_W<'a> { w: &'a mut W }
...
pub struct DOWN1_W<'a> { w: &'a mut W }
...
pub struct DOWN2_W<'a> { w: &'a mut W }
...
pub struct DOWN3_W<'a> { w: &'a mut W }
...
impl R {
    ...
    #[inline(always)]
    pub fn gcen0(&self) -> GCEN0_R { GCEN0_R::new((self.bits & 0x01) != 0) }
    #[doc = "Bit 1 - Gray Count ENable"]
    #[inline(always)]
    pub fn gcen1(&self) -> GCEN1_R { GCEN1_R::new(((self.bits >> 1) & 0x01) != 0) }
    #[doc = "Bit 2 - Gray Count ENable"]
    #[inline(always)]
    pub fn gcen2(&self) -> GCEN2_R { GCEN2_R::new(((self.bits >> 2) & 0x01) != 0) }
    #[doc = "Bit 3 - Gray Count ENable"]
    #[inline(always)]
    pub fn gcen3(&self) -> GCEN3_R { GCEN3_R::new(((self.bits >> 3) & 0x01) != 0) }
    #[doc = "Bit 16 - DOWN Count"]
    #[inline(always)]
    pub fn down0(&self) -> DOWN0_R { DOWN0_R::new(((self.bits >> 16) & 0x01) != 0) }
    #[doc = "Bit 17 - DOWN Count"]
    #[inline(always)]
    pub fn down1(&self) -> DOWN1_R { DOWN1_R::new(((self.bits >> 17) & 0x01) != 0) }
    #[doc = "Bit 18 - DOWN Count"]
    #[inline(always)]
    pub fn down2(&self) -> DOWN2_R { DOWN2_R::new(((self.bits >> 18) & 0x01) != 0) }
    #[doc = "Bit 19 - DOWN Count"]
    #[inline(always)]
    pub fn down3(&self) -> DOWN3_R { DOWN3_R::new(((self.bits >> 19) & 0x01) != 0) }
}

impl W {
    #[doc = "Bit 0 - Gray Count ENable"]
    #[inline(always)]
    pub fn gcen0(&mut self) -> GCEN0_W { GCEN0_W { w: self } }
    #[doc = "Bit 1 - Gray Count ENable"]
    #[inline(always)]
    pub fn gcen1(&mut self) -> GCEN1_W { GCEN1_W { w: self } }
    #[doc = "Bit 2 - Gray Count ENable"]
    #[inline(always)]
    pub fn gcen2(&mut self) -> GCEN2_W { GCEN2_W { w: self } }
    #[doc = "Bit 3 - Gray Count ENable"]
    #[inline(always)]
    pub fn gcen3(&mut self) -> GCEN3_W { GCEN3_W { w: self } }
    #[doc = "Bit 16 - DOWN Count"]
    #[inline(always)]
    pub fn down0(&mut self) -> DOWN0_W { DOWN0_W { w: self } }
    #[doc = "Bit 17 - DOWN Count"]
    #[inline(always)]
    pub fn down1(&mut self) -> DOWN1_W { DOWN1_W { w: self } }
    #[doc = "Bit 18 - DOWN Count"]
    #[inline(always)]
    pub fn down2(&mut self) -> DOWN2_W { DOWN2_W { w: self } }
    #[doc = "Bit 19 - DOWN Count"]
    #[inline(always)]
    pub fn down3(&mut self) -> DOWN3_W { DOWN3_W { w: self } }
}