...
pub struct CLDIV_W<'a> { w: &'a mut W }
...
pub struct CHDIV_W<'a> { w: &'a mut W }
...
pub struct CKDIV_W<'a> { w: &'a mut W }
...
impl R {
    ...
    #[inline(always)]
    pub fn cldiv(&self) -> CLDIV_R { CLDIV_R::new((self.bits & 0xff) as u8) }
    #[doc = "Bits 8:15 - Clock High Divider"]
    #[inline(always)]
    pub fn chdiv(&self) -> CHDIV_R { CHDIV_R::new(((self.bits >> 8) & 0xff) as u8) }
    #[doc = "Bits 16:18 - Clock Divider"]
    #[inline(always)]
    pub fn ckdiv(&self) -> CKDIV_R { CKDIV_R::new(((self.bits >> 16) & 0x07) as u8) }
}

impl W {
    #[doc = "Bits 0:7 - Clock Low Divider"]
    #[inline(always)]
    pub fn cldiv(&mut self) -> CLDIV_W { CLDIV_W { w: self } }
    #[doc = "Bits 8:15 - Clock High Divider"]
    #[inline(always)]
    pub fn chdiv(&mut self) -> CHDIV_W { CHDIV_W { w: self } }
    #[doc = "Bits 16:18 - Clock Divider"]
    #[inline(always)]
    pub fn ckdiv(&mut self) -> CKDIV_W { CKDIV_W { w: self } }
}