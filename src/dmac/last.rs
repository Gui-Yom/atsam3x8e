...
pub struct SLAST0_W<'a> { w: &'a mut W }
...
pub struct DLAST0_W<'a> { w: &'a mut W }
...
pub struct SLAST1_W<'a> { w: &'a mut W }
...
pub struct DLAST1_W<'a> { w: &'a mut W }
...
pub struct SLAST2_W<'a> { w: &'a mut W }
...
pub struct DLAST2_W<'a> { w: &'a mut W }
...
pub struct SLAST3_W<'a> { w: &'a mut W }
...
pub struct DLAST3_W<'a> { w: &'a mut W }
...
pub struct SLAST4_W<'a> { w: &'a mut W }
...
pub struct DLAST4_W<'a> { w: &'a mut W }
...
pub struct SLAST5_W<'a> { w: &'a mut W }
...
pub struct DLAST5_W<'a> { w: &'a mut W }
...
impl R {
    ...
    #[inline(always)]
    pub fn slast0(&self) -> SLAST0_R { SLAST0_R::new((self.bits & 0x01) != 0) }
    #[doc = "Bit 1 - Destination Last"]
    #[inline(always)]
    pub fn dlast0(&self) -> DLAST0_R { DLAST0_R::new(((self.bits >> 1) & 0x01) != 0) }
    #[doc = "Bit 2 - Source Last"]
    #[inline(always)]
    pub fn slast1(&self) -> SLAST1_R { SLAST1_R::new(((self.bits >> 2) & 0x01) != 0) }
    #[doc = "Bit 3 - Destination Last"]
    #[inline(always)]
    pub fn dlast1(&self) -> DLAST1_R { DLAST1_R::new(((self.bits >> 3) & 0x01) != 0) }
    #[doc = "Bit 4 - Source Last"]
    #[inline(always)]
    pub fn slast2(&self) -> SLAST2_R { SLAST2_R::new(((self.bits >> 4) & 0x01) != 0) }
    #[doc = "Bit 5 - Destination Last"]
    #[inline(always)]
    pub fn dlast2(&self) -> DLAST2_R { DLAST2_R::new(((self.bits >> 5) & 0x01) != 0) }
    #[doc = "Bit 6 - Source Last"]
    #[inline(always)]
    pub fn slast3(&self) -> SLAST3_R { SLAST3_R::new(((self.bits >> 6) & 0x01) != 0) }
    #[doc = "Bit 7 - Destination Last"]
    #[inline(always)]
    pub fn dlast3(&self) -> DLAST3_R { DLAST3_R::new(((self.bits >> 7) & 0x01) != 0) }
    #[doc = "Bit 8 - Source Last"]
    #[inline(always)]
    pub fn slast4(&self) -> SLAST4_R { SLAST4_R::new(((self.bits >> 8) & 0x01) != 0) }
    #[doc = "Bit 9 - Destination Last"]
    #[inline(always)]
    pub fn dlast4(&self) -> DLAST4_R { DLAST4_R::new(((self.bits >> 9) & 0x01) != 0) }
    #[doc = "Bit 10 - Source Last"]
    #[inline(always)]
    pub fn slast5(&self) -> SLAST5_R { SLAST5_R::new(((self.bits >> 10) & 0x01) != 0) }
    #[doc = "Bit 11 - Destination Last"]
    #[inline(always)]
    pub fn dlast5(&self) -> DLAST5_R { DLAST5_R::new(((self.bits >> 11) & 0x01) != 0) }
}

impl W {
    #[doc = "Bit 0 - Source Last"]
    #[inline(always)]
    pub fn slast0(&mut self) -> SLAST0_W { SLAST0_W { w: self } }
    #[doc = "Bit 1 - Destination Last"]
    #[inline(always)]
    pub fn dlast0(&mut self) -> DLAST0_W { DLAST0_W { w: self } }
    #[doc = "Bit 2 - Source Last"]
    #[inline(always)]
    pub fn slast1(&mut self) -> SLAST1_W { SLAST1_W { w: self } }
    #[doc = "Bit 3 - Destination Last"]
    #[inline(always)]
    pub fn dlast1(&mut self) -> DLAST1_W { DLAST1_W { w: self } }
    #[doc = "Bit 4 - Source Last"]
    #[inline(always)]
    pub fn slast2(&mut self) -> SLAST2_W { SLAST2_W { w: self } }
    #[doc = "Bit 5 - Destination Last"]
    #[inline(always)]
    pub fn dlast2(&mut self) -> DLAST2_W { DLAST2_W { w: self } }
    #[doc = "Bit 6 - Source Last"]
    #[inline(always)]
    pub fn slast3(&mut self) -> SLAST3_W { SLAST3_W { w: self } }
    #[doc = "Bit 7 - Destination Last"]
    #[inline(always)]
    pub fn dlast3(&mut self) -> DLAST3_W { DLAST3_W { w: self } }
    #[doc = "Bit 8 - Source Last"]
    #[inline(always)]
    pub fn slast4(&mut self) -> SLAST4_W { SLAST4_W { w: self } }
    #[doc = "Bit 9 - Destination Last"]
    #[inline(always)]
    pub fn dlast4(&mut self) -> DLAST4_W { DLAST4_W { w: self } }
    #[doc = "Bit 10 - Source Last"]
    #[inline(always)]
    pub fn slast5(&mut self) -> SLAST5_W { SLAST5_W { w: self } }
    #[doc = "Bit 11 - Destination Last"]
    #[inline(always)]
    pub fn dlast5(&mut self) -> DLAST5_W { DLAST5_W { w: self } }
}