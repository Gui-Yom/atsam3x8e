...
pub struct CBTC0_W<'a> { w: &'a mut W }
...
pub struct CBTC1_W<'a> { w: &'a mut W }
...
pub struct CBTC2_W<'a> { w: &'a mut W }
...
pub struct CBTC3_W<'a> { w: &'a mut W }
...
pub struct CBTC4_W<'a> { w: &'a mut W }
...
pub struct CBTC5_W<'a> { w: &'a mut W }
...
impl W {
    ...
    #[inline(always)]
    pub fn btc0(&mut self) -> BTC0_W { BTC0_W { w: self } }
    #[doc = "Bit 1 - Buffer Transfer Completed \\[5:0\\]"]
    #[inline(always)]
    pub fn btc1(&mut self) -> BTC1_W { BTC1_W { w: self } }
    #[doc = "Bit 2 - Buffer Transfer Completed \\[5:0\\]"]
    #[inline(always)]
    pub fn btc2(&mut self) -> BTC2_W { BTC2_W { w: self } }
    #[doc = "Bit 3 - Buffer Transfer Completed \\[5:0\\]"]
    #[inline(always)]
    pub fn btc3(&mut self) -> BTC3_W { BTC3_W { w: self } }
    #[doc = "Bit 4 - Buffer Transfer Completed \\[5:0\\]"]
    #[inline(always)]
    pub fn btc4(&mut self) -> BTC4_W { BTC4_W { w: self } }
    #[doc = "Bit 5 - Buffer Transfer Completed \\[5:0\\]"]
    #[inline(always)]
    pub fn btc5(&mut self) -> BTC5_W { BTC5_W { w: self } }
    #[doc = "Bit 8 - Chained Buffer Transfer Completed \\[5:0\\]"]
    #[inline(always)]
    pub fn cbtc0(&mut self) -> CBTC0_W { CBTC0_W { w: self } }
    #[doc = "Bit 9 - Chained Buffer Transfer Completed \\[5:0\\]"]
    #[inline(always)]
    pub fn cbtc1(&mut self) -> CBTC1_W { CBTC1_W { w: self } }
    #[doc = "Bit 10 - Chained Buffer Transfer Completed \\[5:0\\]"]
    #[inline(always)]
    pub fn cbtc2(&mut self) -> CBTC2_W { CBTC2_W { w: self } }
    #[doc = "Bit 11 - Chained Buffer Transfer Completed \\[5:0\\]"]
    #[inline(always)]
    pub fn cbtc3(&mut self) -> CBTC3_W { CBTC3_W { w: self } }
    #[doc = "Bit 12 - Chained Buffer Transfer Completed \\[5:0\\]"]
    #[inline(always)]
    pub fn cbtc4(&mut self) -> CBTC4_W { CBTC4_W { w: self } }
    #[doc = "Bit 13 - Chained Buffer Transfer Completed \\[5:0\\]"]
    #[inline(always)]
    pub fn cbtc5(&mut self) -> CBTC5_W { CBTC5_W { w: self } }
    #[doc = "Bit 16 - Access Error \\[5:0\\]"]
    #[inline(always)]
    pub fn err0(&mut self) -> ERR0_W { ERR0_W { w: self } }
    #[doc = "Bit 17 - Access Error \\[5:0\\]"]
    #[inline(always)]
    pub fn err1(&mut self) -> ERR1_W { ERR1_W { w: self } }
    #[doc = "Bit 18 - Access Error \\[5:0\\]"]
    #[inline(always)]
    pub fn err2(&mut self) -> ERR2_W { ERR2_W { w: self } }
    #[doc = "Bit 19 - Access Error \\[5:0\\]"]
    #[inline(always)]
    pub fn err3(&mut self) -> ERR3_W { ERR3_W { w: self } }
    #[doc = "Bit 20 - Access Error \\[5:0\\]"]
    #[inline(always)]
    pub fn err4(&mut self) -> ERR4_W { ERR4_W { w: self } }
    #[doc = "Bit 21 - Access Error \\[5:0\\]"]
    #[inline(always)]
    pub fn err5(&mut self) -> ERR5_W { ERR5_W { w: self } }
}