...
impl crate::ResetValue for super::CALR {
    #[inline(always)]
    fn reset_value() -> Self::Ux { 0x0121_0720 }
}
...
pub struct MONTH_W<'a> { w: &'a mut W }
...
impl R {
    ...
    #[inline(always)]
    pub fn cent(&self) -> CENT_R { CENT_R::new((self.bits & 0x7f) as u8) }
    #[doc = "Bits 8:15 - Current Year"]
    #[inline(always)]
    pub fn year(&self) -> YEAR_R { YEAR_R::new(((self.bits >> 8) & 0xff) as u8) }
    #[doc = "Bits 16:20 - Current Month"]
    #[inline(always)]
    pub fn month(&self) -> MONTH_R { MONTH_R::new(((self.bits >> 16) & 0x1f) as u8) }
    #[doc = "Bits 21:23 - Current Day in Current Week"]
    #[inline(always)]
    pub fn day(&self) -> DAY_R { DAY_R::new(((self.bits >> 21) & 0x07) as u8) }
    #[doc = "Bits 24:29 - Current Day in Current Month"]
    #[inline(always)]
    pub fn date(&self) -> DATE_R { DATE_R::new(((self.bits >> 24) & 0x3f) as u8) }
}

impl W {
    #[doc = "Bits 0:6 - Current Century"]
    #[inline(always)]
    pub fn cent(&mut self) -> CENT_W { CENT_W { w: self } }
    #[doc = "Bits 8:15 - Current Year"]
    #[inline(always)]
    pub fn year(&mut self) -> YEAR_W { YEAR_W { w: self } }
    #[doc = "Bits 16:20 - Current Month"]
    #[inline(always)]
    pub fn month(&mut self) -> MONTH_W { MONTH_W { w: self } }
    #[doc = "Bits 21:23 - Current Day in Current Week"]
    #[inline(always)]
    pub fn day(&mut self) -> DAY_W { DAY_W { w: self } }
    #[doc = "Bits 24:29 - Current Day in Current Month"]
    #[inline(always)]
    pub fn date(&mut self) -> DATE_W { DATE_W { w: self } }
}