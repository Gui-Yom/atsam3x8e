...
pub struct ACKEN_W<'a> { w: &'a mut W }
...
pub struct ALREN_W<'a> { w: &'a mut W }
...
pub struct TIMEN_W<'a> { w: &'a mut W }
...
pub struct CALEN_W<'a> { w: &'a mut W }
