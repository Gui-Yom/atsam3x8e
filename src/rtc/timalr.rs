...
pub struct SECEN_W<'a> { w: &'a mut W }
...
pub struct MINEN_W<'a> { w: &'a mut W }
...
pub struct HOUREN_W<'a> { w: &'a mut W }
...
impl R {
    ...
    #[inline(always)]
    pub fn sec(&self) -> SEC_R { SEC_R::new((self.bits & 0x7f) as u8) }
    #[doc = "Bit 7 - Second Alarm Enable"]
    #[inline(always)]
    pub fn secen(&self) -> SECEN_R { SECEN_R::new(((self.bits >> 7) & 0x01) != 0) }
    #[doc = "Bits 8:14 - Minute Alarm"]
    #[inline(always)]
    pub fn min(&self) -> MIN_R { MIN_R::new(((self.bits >> 8) & 0x7f) as u8) }
    #[doc = "Bit 15 - Minute Alarm Enable"]
    #[inline(always)]
    pub fn minen(&self) -> MINEN_R { MINEN_R::new(((self.bits >> 15) & 0x01) != 0) }
    #[doc = "Bits 16:21 - Hour Alarm"]
    #[inline(always)]
    pub fn hour(&self) -> HOUR_R { HOUR_R::new(((self.bits >> 16) & 0x3f) as u8) }
    #[doc = "Bit 22 - AM/PM Indicator"]
    #[inline(always)]
    pub fn ampm(&self) -> AMPM_R { AMPM_R::new(((self.bits >> 22) & 0x01) != 0) }
    #[doc = "Bit 23 - Hour Alarm Enable"]
    #[inline(always)]
    pub fn houren(&self) -> HOUREN_R { HOUREN_R::new(((self.bits >> 23) & 0x01) != 0) }
}

impl W {
    #[doc = "Bits 0:6 - Second Alarm"]
    #[inline(always)]
    pub fn sec(&mut self) -> SEC_W { SEC_W { w: self } }
    #[doc = "Bit 7 - Second Alarm Enable"]
    #[inline(always)]
    pub fn secen(&mut self) -> SECEN_W { SECEN_W { w: self } }
    #[doc = "Bits 8:14 - Minute Alarm"]
    #[inline(always)]
    pub fn min(&mut self) -> MIN_W { MIN_W { w: self } }
    #[doc = "Bit 15 - Minute Alarm Enable"]
    #[inline(always)]
    pub fn minen(&mut self) -> MINEN_W { MINEN_W { w: self } }
    #[doc = "Bits 16:21 - Hour Alarm"]
    #[inline(always)]
    pub fn hour(&mut self) -> HOUR_W { HOUR_W { w: self } }
    #[doc = "Bit 22 - AM/PM Indicator"]
    #[inline(always)]
    pub fn ampm(&mut self) -> AMPM_W { AMPM_W { w: self } }
    #[doc = "Bit 23 - Hour Alarm Enable"]
    #[inline(always)]
    pub fn houren(&mut self) -> HOUREN_W { HOUREN_W { w: self } }
}