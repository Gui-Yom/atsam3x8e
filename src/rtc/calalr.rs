...
impl crate::ResetValue for super::CALALR {
    #[inline(always)]
    fn reset_value() -> Self::Ux { 0x0101_0000 }
}
...
pub struct MTHEN_W<'a> { w: &'a mut W }
...
pub struct DATEEN_W<'a> { w: &'a mut W }
...
impl R {
    ...
    #[inline(always)]
    pub fn mthen(&self) -> MTHEN_R { MTHEN_R::new(((self.bits >> 23) & 0x01) != 0) }
    #[doc = "Bits 24:29 - Date Alarm"]
    #[inline(always)]
    pub fn date(&self) -> DATE_R { DATE_R::new(((self.bits >> 24) & 0x3f) as u8) }
    #[doc = "Bit 31 - Date Alarm Enable"]
    #[inline(always)]
    pub fn dateen(&self) -> DATEEN_R { DATEEN_R::new(((self.bits >> 31) & 0x01) != 0) }
}
...
impl W {
    ...
    #[doc = "Bit 23 - Month Alarm Enable"]
    #[inline(always)]
    pub fn mthen(&mut self) -> MTHEN_W { MTHEN_W { w: self } }
    #[doc = "Bits 24:29 - Date Alarm"]
    #[inline(always)]
    pub fn date(&mut self) -> DATE_W { DATE_W { w: self } }
    #[doc = "Bit 31 - Date Alarm Enable"]
    #[inline(always)]
    pub fn dateen(&mut self) -> DATEEN_W { DATEEN_W { w: self } }
}