...
pub struct IBCTLCH0_W<'a> { w: &'a mut W }
...
pub struct IBCTLCH1_W<'a> { w: &'a mut W }
...
pub struct IBCTLDACCORE_W<'a> { w: &'a mut W }
...
impl R {
    ...
    #[inline(always)]
    pub fn ibctlch0(&self) -> IBCTLCH0_R { IBCTLCH0_R::new((self.bits & 0x03) as u8) }
    #[doc = "Bits 2:3 - Analog Output Current Control"]
    #[inline(always)]
    pub fn ibctlch1(&self) -> IBCTLCH1_R { IBCTLCH1_R::new(((self.bits >> 2) & 0x03) as u8) }
    #[doc = "Bits 8:9 - Bias Current Control for DAC Core"]
    #[inline(always)]
    pub fn ibctldaccore(&self) -> IBCTLDACCORE_R { IBCTLDACCORE_R::new(((self.bits >> 8) & 0x03) as u8) }
}

impl W {
    #[doc = "Bits 0:1 - Analog Output Current Control"]
    #[inline(always)]
    pub fn ibctlch0(&mut self) -> IBCTLCH0_W { IBCTLCH0_W { w: self } }
    #[doc = "Bits 2:3 - Analog Output Current Control"]
    #[inline(always)]
    pub fn ibctlch1(&mut self) -> IBCTLCH1_W { IBCTLCH1_W { w: self } }
    #[doc = "Bits 8:9 - Bias Current Control for DAC Core"]
    #[inline(always)]
    pub fn ibctldaccore(&mut self) -> IBCTLDACCORE_W { IBCTLDACCORE_W { w: self } }
}