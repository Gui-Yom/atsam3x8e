...
pub struct GPBR_VALUE_W<'a> { w: &'a mut W }
...
impl R {
    ...
    #[inline(always)]
    pub fn gpbr_value(&self) -> GPBR_VALUE_R { GPBR_VALUE_R::new((self.bits & 0xffff_ffff) as u32) }
}

impl W {
    #[doc = "Bits 0:31 - Value of GPBR x"]
    #[inline(always)]
    pub fn gpbr_value(&mut self) -> GPBR_VALUE_W { GPBR_VALUE_W { w: self } }
}