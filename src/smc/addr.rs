...
pub struct ADDR_CYCLE0_W<'a> { w: &'a mut W }
...
impl R {
    ...
    #[inline(always)]
    pub fn addr_cycle0(&self) -> ADDR_CYCLE0_R { ADDR_CYCLE0_R::new((self.bits & 0xff) as u8) }
}

impl W {
    #[doc = "Bits 0:7 - NAND Flash Array Address cycle 0"]
    #[inline(always)]
    pub fn addr_cycle0(&mut self) -> ADDR_CYCLE0_W { ADDR_CYCLE0_W { w: self } }
}