...
pub type ECCERR0_R = crate::R<u8, u8>;
...
impl R {
    ...
    #[inline(always)]
    pub fn recerr4(&self) -> RECERR4_R { RECERR4_R::new(((self.bits >> 16) & 0x01) != 0) }
    #[doc = "Bits 17:18 - ECC Error in the page between the 1024th and the 1279th bytes or between the 2048th and the 2559th bytes"]
    #[inline(always)]
    pub fn eccerr4(&self) -> ECCERR4_R { ECCERR4_R::new(((self.bits >> 17) & 0x03) as u8) }
    ...
    #[inline(always)]
    pub fn recerr5(&self) -> RECERR5_R { RECERR5_R::new(((self.bits >> 20) & 0x01) != 0) }
    #[doc = "Bits 21:22 - ECC Error in the page between the 1280th and the 1535th bytes or between the 2560th and the 3071st bytes"]
    #[inline(always)]
    pub fn eccerr5(&self) -> ECCERR5_R { ECCERR5_R::new(((self.bits >> 21) & 0x03) as u8) }
    ...
    #[inline(always)]
    pub fn recerr6(&self) -> RECERR6_R { RECERR6_R::new(((self.bits >> 24) & 0x01) != 0) }
    #[doc = "Bits 25:26 - ECC Error in the page between the 1536th and the 1791st bytes or between the 3072nd and the 3583rd bytes"]
    #[inline(always)]
    pub fn eccerr6(&self) -> ECCERR6_R { ECCERR6_R::new(((self.bits >> 25) & 0x03) as u8) }
    ...
    #[inline(always)]
    pub fn recerr7(&self) -> RECERR7_R { RECERR7_R::new(((self.bits >> 28) & 0x01) != 0) }
    #[doc = "Bits 29:30 - ECC Error in the page between the 1792nd and the 2047th bytes or between the 3584th and the 4095th bytes"]
    #[inline(always)]
    pub fn eccerr7(&self) -> ECCERR7_R { ECCERR7_R::new(((self.bits >> 29) & 0x03) as u8) }
}