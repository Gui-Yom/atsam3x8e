...
pub struct RB_RISE_W<'a> { w: &'a mut W }
...
pub struct RB_FALL_W<'a> { w: &'a mut W }
...
pub struct CMDDONE_W<'a> { w: &'a mut W }
...
pub struct UNDEF_W<'a> { w: &'a mut W }
...
pub struct NFCASE_W<'a> { w: &'a mut W }
...
pub struct RB_EDGE0_W<'a> { w: &'a mut W }
...
impl W {
    ...
    #[inline(always)]
    pub fn rb_rise(&mut self) -> RB_RISE_W { RB_RISE_W { w: self } }
    #[doc = "Bit 5 - Ready Busy Falling Edge Detection Interrupt Enable"]
    #[inline(always)]
    pub fn rb_fall(&mut self) -> RB_FALL_W { RB_FALL_W { w: self } }
    ...
    #[inline(always)]
    pub fn cmddone(&mut self) -> CMDDONE_W { CMDDONE_W { w: self } }
    ...
    #[inline(always)]
    pub fn undef(&mut self) -> UNDEF_W { UNDEF_W { w: self } }
    #[doc = "Bit 22 - Accessing While Busy Interrupt Enable"]
    #[inline(always)]
    pub fn awb(&mut self) -> AWB_W { AWB_W { w: self } }
    #[doc = "Bit 23 - NFC Access Size Error Interrupt Enable"]
    #[inline(always)]
    pub fn nfcase(&mut self) -> NFCASE_W { NFCASE_W { w: self } }
    #[doc = "Bit 24 - Ready/Busy Line 0 Interrupt Enable"]
    #[inline(always)]
    pub fn rb_edge0(&mut self) -> RB_EDGE0_W { RB_EDGE0_W { w: self } }
}