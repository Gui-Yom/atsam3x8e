...
pub struct RBNSEL_W<'a> { w: &'a mut W }
...
pub struct NFSEL_W<'a> { w: &'a mut W }
...
impl R {
    ...
    #[inline(always)]
    pub fn tclr(&self) -> TCLR_R { TCLR_R::new((self.bits & 0x0f) as u8) }
    #[doc = "Bits 4:7 - ALE to Data Start"]
    #[inline(always)]
    pub fn tadl(&self) -> TADL_R { TADL_R::new(((self.bits >> 4) & 0x0f) as u8) }
    #[doc = "Bits 8:11 - ALE to REN Low Delay"]
    #[inline(always)]
    pub fn tar(&self) -> TAR_R { TAR_R::new(((self.bits >> 8) & 0x0f) as u8) }
    #[doc = "Bit 12 - Off Chip Memory Scrambling Enable"]
    #[inline(always)]
    pub fn ocms(&self) -> OCMS_R { OCMS_R::new(((self.bits >> 12) & 0x01) != 0) }
    #[doc = "Bits 16:19 - Ready to REN Low Delay"]
    #[inline(always)]
    pub fn trr(&self) -> TRR_R { TRR_R::new(((self.bits >> 16) & 0x0f) as u8) }
    #[doc = "Bits 24:27 - WEN High to REN to Busy"]
    #[inline(always)]
    pub fn twb(&self) -> TWB_R { TWB_R::new(((self.bits >> 24) & 0x0f) as u8) }
    #[doc = "Bits 28:30 - Ready/Busy Line Selection"]
    #[inline(always)]
    pub fn rbnsel(&self) -> RBNSEL_R { RBNSEL_R::new(((self.bits >> 28) & 0x07) as u8) }
    #[doc = "Bit 31 - NAND Flash Selection"]
    #[inline(always)]
    pub fn nfsel(&self) -> NFSEL_R { NFSEL_R::new(((self.bits >> 31) & 0x01) != 0) }
}

impl W {
    #[doc = "Bits 0:3 - CLE to REN Low Delay"]
    #[inline(always)]
    pub fn tclr(&mut self) -> TCLR_W { TCLR_W { w: self } }
    #[doc = "Bits 4:7 - ALE to Data Start"]
    #[inline(always)]
    pub fn tadl(&mut self) -> TADL_W { TADL_W { w: self } }
    #[doc = "Bits 8:11 - ALE to REN Low Delay"]
    #[inline(always)]
    pub fn tar(&mut self) -> TAR_W { TAR_W { w: self } }
    #[doc = "Bit 12 - Off Chip Memory Scrambling Enable"]
    #[inline(always)]
    pub fn ocms(&mut self) -> OCMS_W { OCMS_W { w: self } }
    #[doc = "Bits 16:19 - Ready to REN Low Delay"]
    #[inline(always)]
    pub fn trr(&mut self) -> TRR_W { TRR_W { w: self } }
    #[doc = "Bits 24:27 - WEN High to REN to Busy"]
    #[inline(always)]
    pub fn twb(&mut self) -> TWB_W { TWB_W { w: self } }
    #[doc = "Bits 28:30 - Ready/Busy Line Selection"]
    #[inline(always)]
    pub fn rbnsel(&mut self) -> RBNSEL_W { RBNSEL_W { w: self } }
    #[doc = "Bit 31 - NAND Flash Selection"]
    #[inline(always)]
    pub fn nfsel(&mut self) -> NFSEL_W { NFSEL_W { w: self } }
}