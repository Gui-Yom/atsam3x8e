...
pub struct RXTEN_W<'a> { w: &'a mut W }
...
pub struct RXTDIS_W<'a> { w: &'a mut W }
...
pub struct TXTEN_W<'a> { w: &'a mut W }
...
pub struct TXTDIS_W<'a> { w: &'a mut W }
...
impl W {
    ...
    #[inline(always)]
    pub fn rxten(&mut self) -> RXTEN_W { RXTEN_W { w: self } }
    #[doc = "Bit 1 - Receiver Transfer Disable"]
    #[inline(always)]
    pub fn rxtdis(&mut self) -> RXTDIS_W { RXTDIS_W { w: self } }
    #[doc = "Bit 8 - Transmitter Transfer Enable"]
    #[inline(always)]
    pub fn txten(&mut self) -> TXTEN_W { TXTEN_W { w: self } }
    #[doc = "Bit 9 - Transmitter Transfer Disable"]
    #[inline(always)]
    pub fn txtdis(&mut self) -> TXTDIS_W { TXTDIS_W { w: self } }
}