...
pub struct RXBRK_W<'a> { w: &'a mut W }
...
pub struct CTSIC_W<'a> { w: &'a mut W }
...
impl W {
    ...
    #[inline(always)]
    pub fn rxbrk(&mut self) -> RXBRK_W { RXBRK_W { w: self } }
    ...
    #[inline(always)]
    pub fn iter(&mut self) -> ITER_W { ITER_W { w: self } }
    ...
    #[inline(always)]
    pub fn ctsic(&mut self) -> CTSIC_W { CTSIC_W { w: self } }
    #[doc = "Bit 24 - Manchester Error Interrupt Disable"]
    #[inline(always)]
    pub fn mane(&mut self) -> MANE_W { MANE_W { w: self } }
}