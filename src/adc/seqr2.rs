...
pub struct USCH9_W<'a> { w: &'a mut W }
...
pub struct USCH10_W<'a> { w: &'a mut W }
...
pub struct USCH11_W<'a> { w: &'a mut W }
...
pub struct USCH12_W<'a> { w: &'a mut W }
...
pub struct USCH13_W<'a> { w: &'a mut W }
...
pub struct USCH14_W<'a> { w: &'a mut W }
...
pub struct USCH15_W<'a> { w: &'a mut W }
...
pub struct USCH16_W<'a> { w: &'a mut W }
...
impl R {
    ...
    #[inline(always)]
    pub fn usch9(&self) -> USCH9_R { USCH9_R::new((self.bits & 0x0f) as u8) }
    #[doc = "Bits 4:7 - User Sequence Number 10"]
    #[inline(always)]
    pub fn usch10(&self) -> USCH10_R { USCH10_R::new(((self.bits >> 4) & 0x0f) as u8) }
    #[doc = "Bits 8:11 - User Sequence Number 11"]
    #[inline(always)]
    pub fn usch11(&self) -> USCH11_R { USCH11_R::new(((self.bits >> 8) & 0x0f) as u8) }
    #[doc = "Bits 12:15 - User Sequence Number 12"]
    #[inline(always)]
    pub fn usch12(&self) -> USCH12_R { USCH12_R::new(((self.bits >> 12) & 0x0f) as u8) }
    #[doc = "Bits 16:19 - User Sequence Number 13"]
    #[inline(always)]
    pub fn usch13(&self) -> USCH13_R { USCH13_R::new(((self.bits >> 16) & 0x0f) as u8) }
    #[doc = "Bits 20:23 - User Sequence Number 14"]
    #[inline(always)]
    pub fn usch14(&self) -> USCH14_R { USCH14_R::new(((self.bits >> 20) & 0x0f) as u8) }
    #[doc = "Bits 24:27 - User Sequence Number 15"]
    #[inline(always)]
    pub fn usch15(&self) -> USCH15_R { USCH15_R::new(((self.bits >> 24) & 0x0f) as u8) }
    #[doc = "Bits 28:31 - User Sequence Number 16"]
    #[inline(always)]
    pub fn usch16(&self) -> USCH16_R { USCH16_R::new(((self.bits >> 28) & 0x0f) as u8) }
}

impl W {
    #[doc = "Bits 0:3 - User Sequence Number 9"]
    #[inline(always)]
    pub fn usch9(&mut self) -> USCH9_W { USCH9_W { w: self } }
    #[doc = "Bits 4:7 - User Sequence Number 10"]
    #[inline(always)]
    pub fn usch10(&mut self) -> USCH10_W { USCH10_W { w: self } }
    #[doc = "Bits 8:11 - User Sequence Number 11"]
    #[inline(always)]
    pub fn usch11(&mut self) -> USCH11_W { USCH11_W { w: self } }
    #[doc = "Bits 12:15 - User Sequence Number 12"]
    #[inline(always)]
    pub fn usch12(&mut self) -> USCH12_W { USCH12_W { w: self } }
    #[doc = "Bits 16:19 - User Sequence Number 13"]
    #[inline(always)]
    pub fn usch13(&mut self) -> USCH13_W { USCH13_W { w: self } }
    #[doc = "Bits 20:23 - User Sequence Number 14"]
    #[inline(always)]
    pub fn usch14(&mut self) -> USCH14_W { USCH14_W { w: self } }
    #[doc = "Bits 24:27 - User Sequence Number 15"]
    #[inline(always)]
    pub fn usch15(&mut self) -> USCH15_W { USCH15_W { w: self } }
    #[doc = "Bits 28:31 - User Sequence Number 16"]
    #[inline(always)]
    pub fn usch16(&mut self) -> USCH16_W { USCH16_W { w: self } }
}