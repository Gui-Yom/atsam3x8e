...
pub struct IBCTL_W<'a> { w: &'a mut W }
...
impl R {
    ...
    #[inline(always)]
    pub fn tson(&self) -> TSON_R { TSON_R::new(((self.bits >> 4) & 0x01) != 0) }
    #[doc = "Bits 8:9 - ADC Bias Current Control"]
    #[inline(always)]
    pub fn ibctl(&self) -> IBCTL_R { IBCTL_R::new(((self.bits >> 8) & 0x03) as u8) }
}

impl W {
    #[doc = "Bit 4 - Temperature Sensor On"]
    #[inline(always)]
    pub fn tson(&mut self) -> TSON_W { TSON_W { w: self } }
    #[doc = "Bits 8:9 - ADC Bias Current Control"]
    #[inline(always)]
    pub fn ibctl(&mut self) -> IBCTL_W { IBCTL_W { w: self } }
}