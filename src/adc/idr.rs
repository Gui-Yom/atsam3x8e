...
pub struct EOC10_W<'a> { w: &'a mut W }
...
pub struct EOC11_W<'a> { w: &'a mut W }
...
pub struct EOC12_W<'a> { w: &'a mut W }
...
pub struct EOC13_W<'a> { w: &'a mut W }
...
pub struct EOC14_W<'a> { w: &'a mut W }
...
pub struct EOC15_W<'a> { w: &'a mut W }
...
pub struct GOVRE_W<'a> { w: &'a mut W }
...
pub struct COMPE_W<'a> { w: &'a mut W }
...
pub struct ENDRX_W<'a> { w: &'a mut W }
...
pub struct RXBUFF_W<'a> { w: &'a mut W }
