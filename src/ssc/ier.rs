...
pub struct OVRUN_W<'a> { w: &'a mut W }
...
pub struct TXSYN_W<'a> { w: &'a mut W }
...
pub struct RXSYN_W<'a> { w: &'a mut W }
...
impl W {
    ...
    #[inline(always)]
    pub fn ovrun(&mut self) -> OVRUN_W { OVRUN_W { w: self } }
    #[doc = "Bit 8 - Compare 0 Interrupt Enable"]
    #[inline(always)]
    pub fn cp0(&mut self) -> CP0_W { CP0_W { w: self } }
    #[doc = "Bit 9 - Compare 1 Interrupt Enable"]
    #[inline(always)]
    pub fn cp1(&mut self) -> CP1_W { CP1_W { w: self } }
    #[doc = "Bit 10 - Tx Sync Interrupt Enable"]
    #[inline(always)]
    pub fn txsyn(&mut self) -> TXSYN_W { TXSYN_W { w: self } }
    #[doc = "Bit 11 - Rx Sync Interrupt Enable"]
    #[inline(always)]
    pub fn rxsyn(&mut self) -> RXSYN_W { RXSYN_W { w: self } }
}