...
impl R {
    ...
    #[inline(always)]
    pub fn bna(&self) -> BNA_R { BNA_R::new((self.bits & 0x01) != 0) }
    #[doc = "Bit 1 - Frame Received"]
    #[inline(always)]
    pub fn rec(&self) -> REC_R { REC_R::new(((self.bits >> 1) & 0x01) != 0) }
    #[doc = "Bit 2 - Receive Overrun"]
    #[inline(always)]
    pub fn ovr(&self) -> OVR_R { OVR_R::new(((self.bits >> 2) & 0x01) != 0) }
}

impl W {
    #[doc = "Bit 0 - Buffer Not Available"]
    #[inline(always)]
    pub fn bna(&mut self) -> BNA_W { BNA_W { w: self } }
    #[doc = "Bit 1 - Frame Received"]
    #[inline(always)]
    pub fn rec(&mut self) -> REC_W { REC_W { w: self } }
    #[doc = "Bit 2 - Receive Overrun"]
    #[inline(always)]
    pub fn ovr(&mut self) -> OVR_W { OVR_W { w: self } }
}