...
pub struct CLKEN_W<'a> { w: &'a mut W }
...
impl R {
    ...
    #[inline(always)]
    pub fn rmii(&self) -> RMII_R { RMII_R::new((self.bits & 0x01) != 0) }
    #[doc = "Bit 1 - Clock Enable"]
    #[inline(always)]
    pub fn clken(&self) -> CLKEN_R { CLKEN_R::new(((self.bits >> 1) & 0x01) != 0) }
}

impl W {
    #[doc = "Bit 0 - Reduce MII"]
    #[inline(always)]
    pub fn rmii(&mut self) -> RMII_W { RMII_W { w: self } }
    #[doc = "Bit 1 - Clock Enable"]
    #[inline(always)]
    pub fn clken(&mut self) -> CLKEN_W { CLKEN_W { w: self } }
}