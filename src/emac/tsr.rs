...
impl R {
    ...
    #[inline(always)]
    pub fn ubr(&self) -> UBR_R { UBR_R::new((self.bits & 0x01) != 0) }
    #[doc = "Bit 1 - Collision Occurred"]
    #[inline(always)]
    pub fn col(&self) -> COL_R { COL_R::new(((self.bits >> 1) & 0x01) != 0) }
    #[doc = "Bit 2 - Retry Limit exceeded"]
    #[inline(always)]
    pub fn rles(&self) -> RLES_R { RLES_R::new(((self.bits >> 2) & 0x01) != 0) }
    #[doc = "Bit 3 - Transmit Go"]
    #[inline(always)]
    pub fn tgo(&self) -> TGO_R { TGO_R::new(((self.bits >> 3) & 0x01) != 0) }
    #[doc = "Bit 4 - Buffers exhausted mid frame"]
    #[inline(always)]
    pub fn bex(&self) -> BEX_R { BEX_R::new(((self.bits >> 4) & 0x01) != 0) }
    #[doc = "Bit 5 - Transmit Complete"]
    #[inline(always)]
    pub fn comp(&self) -> COMP_R { COMP_R::new(((self.bits >> 5) & 0x01) != 0) }
    #[doc = "Bit 6 - Transmit Underrun"]
    #[inline(always)]
    pub fn und(&self) -> UND_R { UND_R::new(((self.bits >> 6) & 0x01) != 0) }
}

impl W {
    #[doc = "Bit 0 - Used Bit Read"]
    #[inline(always)]
    pub fn ubr(&mut self) -> UBR_W { UBR_W { w: self } }
    #[doc = "Bit 1 - Collision Occurred"]
    #[inline(always)]
    pub fn col(&mut self) -> COL_W { COL_W { w: self } }
    #[doc = "Bit 2 - Retry Limit exceeded"]
    #[inline(always)]
    pub fn rles(&mut self) -> RLES_W { RLES_W { w: self } }
    #[doc = "Bit 3 - Transmit Go"]
    #[inline(always)]
    pub fn tgo(&mut self) -> TGO_W { TGO_W { w: self } }
    #[doc = "Bit 4 - Buffers exhausted mid frame"]
    #[inline(always)]
    pub fn bex(&mut self) -> BEX_W { BEX_W { w: self } }
    #[doc = "Bit 5 - Transmit Complete"]
    #[inline(always)]
    pub fn comp(&mut self) -> COMP_W { COMP_W { w: self } }
    #[doc = "Bit 6 - Transmit Underrun"]
    #[inline(always)]
    pub fn und(&mut self) -> UND_W { UND_W { w: self } }
}