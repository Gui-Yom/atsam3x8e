...
pub struct CLRSTAT_W<'a> { w: &'a mut W }
...
pub struct INCSTAT_W<'a> { w: &'a mut W }
...
pub struct WESTAT_W<'a> { w: &'a mut W }
...
pub struct TSTART_W<'a> { w: &'a mut W }
...
pub struct THALT_W<'a> { w: &'a mut W }
...
impl R {
    #[doc = "Bit 0 - LoopBack"]
    #[inline(always)]
    pub fn lb(&self) -> LB_R { LB_R::new((self.bits & 0x01) != 0) }
    #[doc = "Bit 1 - Loopback local"]
    #[inline(always)]
    pub fn llb(&self) -> LLB_R { LLB_R::new(((self.bits >> 1) & 0x01) != 0) }
    #[doc = "Bit 2 - Receive enable"]
    #[inline(always)]
    pub fn re(&self) -> RE_R { RE_R::new(((self.bits >> 2) & 0x01) != 0) }
    #[doc = "Bit 3 - Transmit enable"]
    #[inline(always)]
    pub fn te(&self) -> TE_R { TE_R::new(((self.bits >> 3) & 0x01) != 0) }
    #[doc = "Bit 4 - Management port enable"]
    #[inline(always)]
    pub fn mpe(&self) -> MPE_R { MPE_R::new(((self.bits >> 4) & 0x01) != 0) }
    #[doc = "Bit 5 - Clear statistics registers"]
    #[inline(always)]
    pub fn clrstat(&self) -> CLRSTAT_R { CLRSTAT_R::new(((self.bits >> 5) & 0x01) != 0) }
    #[doc = "Bit 6 - Increment statistics registers"]
    #[inline(always)]
    pub fn incstat(&self) -> INCSTAT_R { INCSTAT_R::new(((self.bits >> 6) & 0x01) != 0) }
    #[doc = "Bit 7 - Write enable for statistics registers"]
    #[inline(always)]
    pub fn westat(&self) -> WESTAT_R { WESTAT_R::new(((self.bits >> 7) & 0x01) != 0) }
    #[doc = "Bit 8 - Back pressure"]
    #[inline(always)]
    pub fn bp(&self) -> BP_R { BP_R::new(((self.bits >> 8) & 0x01) != 0) }
    #[doc = "Bit 9 - Start transmission"]
    #[inline(always)]
    pub fn tstart(&self) -> TSTART_R { TSTART_R::new(((self.bits >> 9) & 0x01) != 0) }
    #[doc = "Bit 10 - Transmit halt"]
    #[inline(always)]
    pub fn thalt(&self) -> THALT_R { THALT_R::new(((self.bits >> 10) & 0x01) != 0) }
}

impl W {
    #[doc = "Bit 0 - LoopBack"]
    #[inline(always)]
    pub fn lb(&mut self) -> LB_W { LB_W { w: self } }
    #[doc = "Bit 1 - Loopback local"]
    #[inline(always)]
    pub fn llb(&mut self) -> LLB_W { LLB_W { w: self } }
    #[doc = "Bit 2 - Receive enable"]
    #[inline(always)]
    pub fn re(&mut self) -> RE_W { RE_W { w: self } }
    #[doc = "Bit 3 - Transmit enable"]
    #[inline(always)]
    pub fn te(&mut self) -> TE_W { TE_W { w: self } }
    #[doc = "Bit 4 - Management port enable"]
    #[inline(always)]
    pub fn mpe(&mut self) -> MPE_W { MPE_W { w: self } }
    #[doc = "Bit 5 - Clear statistics registers"]
    #[inline(always)]
    pub fn clrstat(&mut self) -> CLRSTAT_W { CLRSTAT_W { w: self } }
    #[doc = "Bit 6 - Increment statistics registers"]
    #[inline(always)]
    pub fn incstat(&mut self) -> INCSTAT_W { INCSTAT_W { w: self } }
    #[doc = "Bit 7 - Write enable for statistics registers"]
    #[inline(always)]
    pub fn westat(&mut self) -> WESTAT_W { WESTAT_W { w: self } }
    #[doc = "Bit 8 - Back pressure"]
    #[inline(always)]
    pub fn bp(&mut self) -> BP_W { BP_W { w: self } }
    #[doc = "Bit 9 - Start transmission"]
    #[inline(always)]
    pub fn tstart(&mut self) -> TSTART_W { TSTART_W { w: self } }
    #[doc = "Bit 10 - Transmit halt"]
    #[inline(always)]
    pub fn thalt(&mut self) -> THALT_W { THALT_W { w: self } }
}