...
pub struct OVRES_W<'a> { w: &'a mut W }
...
pub struct UNDES_W<'a> { w: &'a mut W }
...
impl W {
    ...
    #[inline(always)]
    pub fn rdrf(&mut self) -> RDRF_W { RDRF_W { w: self } }
    #[doc = "Bit 1 - SPI Transmit Data Register Empty Interrupt Disable"]
    #[inline(always)]
    pub fn tdre(&mut self) -> TDRE_W { TDRE_W { w: self } }
    #[doc = "Bit 2 - Mode Fault Error Interrupt Disable"]
    #[inline(always)]
    pub fn modf(&mut self) -> MODF_W { MODF_W { w: self } }
    #[doc = "Bit 3 - Overrun Error Interrupt Disable"]
    #[inline(always)]
    pub fn ovres(&mut self) -> OVRES_W { OVRES_W { w: self } }
    #[doc = "Bit 8 - NSS Rising Interrupt Disable"]
    #[inline(always)]
    pub fn nssr(&mut self) -> NSSR_W { NSSR_W { w: self } }
    ...
    #[inline(always)]
    pub fn undes(&mut self) -> UNDES_W { UNDES_W { w: self } }
}