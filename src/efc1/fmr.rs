...
impl R {
    ...
    #[inline(always)]
    pub fn frdy(&self) -> FRDY_R { FRDY_R::new((self.bits & 0x01) != 0) }
    #[doc = "Bits 8:11 - Flash Wait State"]
    #[inline(always)]
    pub fn fws(&self) -> FWS_R { FWS_R::new(((self.bits >> 8) & 0x0f) as u8) }
    #[doc = "Bit 16 - Sequential Code Optimization Disable"]
    #[inline(always)]
    pub fn scod(&self) -> SCOD_R { SCOD_R::new(((self.bits >> 16) & 0x01) != 0) }
    #[doc = "Bit 24 - Flash Access Mode"]
    #[inline(always)]
    pub fn fam(&self) -> FAM_R { FAM_R::new(((self.bits >> 24) & 0x01) != 0) }
}

impl W {
    #[doc = "Bit 0 - Ready Interrupt Enable"]
    #[inline(always)]
    pub fn frdy(&mut self) -> FRDY_W { FRDY_W { w: self } }
    #[doc = "Bits 8:11 - Flash Wait State"]
    #[inline(always)]
    pub fn fws(&mut self) -> FWS_W { FWS_W { w: self } }
    #[doc = "Bit 16 - Sequential Code Optimization Disable"]
    #[inline(always)]
    pub fn scod(&mut self) -> SCOD_W { SCOD_W { w: self } }
    #[doc = "Bit 24 - Flash Access Mode"]
    #[inline(always)]
    pub fn fam(&mut self) -> FAM_W { FAM_W { w: self } }
}