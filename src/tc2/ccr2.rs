...
pub struct CLKDIS_W<'a> { w: &'a mut W }
...
pub struct SWTRG_W<'a> { w: &'a mut W }
...
impl W {
    ...
    #[inline(always)]
    pub fn clkdis(&mut self) -> CLKDIS_W { CLKDIS_W { w: self } }
    #[doc = "Bit 2 - Software Trigger Command"]
    #[inline(always)]
    pub fn swtrg(&mut self) -> SWTRG_W { SWTRG_W { w: self } }
}